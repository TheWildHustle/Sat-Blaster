...
// node_modules/irisdb-nostr/dist/irisdb-nostr.es.js
var gi = Object.defineProperty;
var bi = (t, e, n) => e in t ? gi(t, e, { enumerable: true, configurable: true, writable: true, value: n }) : t[e] = n;
var M = (t, e, n) => (bi(t, typeof e != "symbol" ? e + "" : e, n), n);
var crypto$6 = typeof globalThis == "object" && "crypto" in globalThis ? globalThis.crypto : void 0;
function number$8(t) {
...
var createView$6 = (t) => new DataView(t.buffer, t.byteOffset, t.byteLength);
var rotr$6 = (t, e) => t << 32 - e | t >>> e;
new Uint8Array(new Uint32Array([287454020]).buffer)[0];
var hexes$7 = Array.from({ length: 256 }, (t, e) => e.toString(16).padStart(2, "0"));
...
var asciis$2 = { _0: 48, _9: 57, _A: 65, _F: 70, _a: 97, _f: 102 };
...
var crypto$5 = typeof globalThis == "object" && "crypto" in globalThis ? globalThis.crypto : void 0;
var u8a$7 = (t) => t instanceof Uint8Array;
var createView$5 = (t) => new DataView(t.buffer, t.byteOffset, t.byteLength);
var rotr$5 = (t, e) => t << 32 - e | t >>> e;
var isLE$7 = new Uint8Array(new Uint32Array([287454020]).buffer)[0] === 68;
if (!isLE$7)
...
var SHA2$5 = class extends Hash$5 {
  constructor(e, n, r, s) {
    super(), this.blockLen = e, this.outputLen = n, this.padOffset = r, this.isLE = s, this.finished = false, this.length = 0, this.pos = 0, this.destroyed = false, this.buffer = new Uint8Array(e), this.view = createView$5(this.buffer);
  }
  update(e) {
    exists$6(this);
  ...
  digestInto(e) {
    exists$6(this), output$6(e, this), this.finished = true;
...
var Chi$6 = (t, e, n) => t & e ^ ~t & n;
var Maj$6 = (t, e, n) => t & e ^ t & n ^ e & n;
var SHA256_K$6 = new Uint32Array([
  1116352408,
  1899447441,
  3049323471,
  3921009573,
...
var SHA256_W$6 = new Uint32Array(64);
var SHA256$6 = class extends SHA2$5 {
  constructor() {
    super(64, 32, 8, false), this.A = IV$5[0] | 0, this.B = IV$5[1] | 0, this.C = IV$5[2] | 0, this.D = IV$5[3] | 0, this.E = IV$5[4] | 0, this.F = IV$5[5] | 0, this.G = IV$5[6] | 0, this.H = IV$5[7] | 0;
  }
  get() {
  ...
  process(e, n) {
    for (let y = 0; y < 16; y++, n += 4)
      SHA256_W$6[y] = e.getUint32(n, false);
    for (let y = 16; y < 64; y++) {
...
var sha256$6 = wrapConstructor$5(() => new SHA256$6());
var _0n$i = BigInt(0);
var _1n$j = BigInt(1);
var _2n$b = BigInt(2);
var u8a$6 = (t) => t instanceof Uint8Array;
var hexes$6 = Array.from({ length: 256 }, (t, e) => e.toString(16).padStart(2, "0"));
...
var bitSet$3 = (t, e, n) => t | (n ? _1n$j : _0n$i) << BigInt(e);
var bitMask$3 = (t) => (_2n$b << BigInt(t - 1)) - _1n$j;
var u8n$3 = (t) => new Uint8Array(t);
var u8fr$3 = (t) => Uint8Array.from(t);
...
var ut$3 = Object.freeze(Object.defineProperty({
  __proto__: null,
  bitGet: bitGet$3,
  bitLen: bitLen$3,
  bitMask: bitMask$3,
...
function Field$3(t, e, n = false, r = {}) {
  if (t <= _0n$h)
...
function mapHashToField$1(t, e, n = false) {
  ...
  return {
    ...
    wNAF(s, o, a) {
      ...
      for (let S = 0; S < c; S++) {
        ...
        let x = Number(a & y);
        a >>= k, x > h && (x -= $, a += _1n$h);
        const A = w, N = w + Math.abs(x) - 1, C2 = S % 2 !== 0, W = x < 0;
        x === 0 ? g = g.add(n(C2, o[A])) : p = p.add(n(W, o[N]));
      }
      return { p, f: g };
    },
    wNAFCached(s, o, a, c) {
...
var { bytesToNumberBE: b2n$3, hexToBytes: h2b$3 } = ut$3;
var DER$3 = {
...
function weierstrassPoints$3(t) {
  ...
  function h(S) {
    ...
    let C2;
    try {
      C2 = typeof S == "bigint" ? S : bytesToNumberBE$3(ensureBytes$4("private key", S, x));
    } catch {
      throw new Error(`private key must be ${x} bytes, hex or bigint, not ${typeof S}`);
    }
    return A && (C2 = mod$3(C2, N)), c(C2), C2;
  }
  ...
  class y {
    ...
    equals(w) {
      g(w);
      const { px: x, py: A, pz: N } = this, { px: C2, py: W, pz: q } = w, I = n.eql(n.mul(x, q), n.mul(C2, N)), L = n.eql(n.mul(A, q), n.mul(W, N));
      return I && L;
    }
    /**
    ...
    double() {
      const { a: w, b: x } = e, A = n.mul(x, _3n$6), { px: N, py: C2, pz: W } = this;
      let q = n.ZERO, I = n.ZERO, L = n.ZERO, P = n.mul(N, N), ie = n.mul(C2, C2), te = n.mul(W, W), T = n.mul(N, C2);
      return T = n.add(T, T), L = n.mul(N, W), L = n.add(L, L), q = n.mul(w, L), I = n.mul(A, te), I = n.add(q, I), q = n.sub(ie, I), I = n.add(ie, I), I = n.mul(q, I), q = n.mul(T, q), L = n.mul(A, L), te = n.mul(w, te), T = n.sub(P, te), T = n.mul(w, T), T = n.add(T, L), L = n.add(P, P), P = n.add(L, P), P = n.add(P, te), P = n.mul(P, T), I = n.add(I, P), te = n.mul(C2, W), te = n.add(te, te), P = n.mul(te, T), q = n.sub(q, P), L = n.mul(te, ie), L = n.add(L, L), L = n.add(L, L), new y(q, I, L);
    }
    ...
    add(w) {
      g(w);
      const { px: x, py: A, pz: N } = this, { px: C2, py: W, pz: q } = w;
      let I = n.ZERO, L = n.ZERO, P = n.ZERO;
      const ie = e.a, te = n.mul(e.b, _3n$6);
      let T = n.mul(x, C2), O = n.mul(A, W), K = n.mul(N, q), ae = n.add(x, A), E2 = n.add(C2, W);
      ae = n.mul(ae, E2), E2 = n.add(T, O), ae = n.sub(ae, E2), E2 = n.add(x, N);
      let B = n.add(C2, q);
      return E2 = n.mul(E2, B), B = n.add(T, K), E2 = n.sub(E2, B), B = n.add(A, N), I = n.add(W, q), B = n.mul(B, I), I = n.add(O, K), B = n.sub(B, I), P = n.mul(ie, E2), I = n.mul(te, K), P = n.add(I, P), I = n.sub(O, P), P = n.add(O, P), L = n.mul(I, P), O = n.add(T, T), O = n.add(O, T), K = n.mul(ie, K), E2 = n.mul(te, E2), O = n.add(O, K), K = n.sub(T, K), K = n.mul(ie, K), E2 = n.add(E2, K), T = n.mul(O, E2), L = n.add(L, T), T = n.mul(B, E2), I = n.mul(ae, I), I = n.sub(I, T), T = n.mul(ae, O), P = n.mul(B, P), P = n.add(P, T), new y(I, L, P);
    }
    subtract(w) {
    ...
    wNAF(w) {
      return k.wNAFCached(this, p, w, (x) => {
        ...
        return x.map((N, C2) => N.toAffine(A[C2])).map(y.fromAffine);
      });
    }
    /**
    ...
    multiplyUnsafe(w) {
      ...
      let { k1neg: N, k1: C2, k2neg: W, k2: q } = A.splitScalar(w), I = x, L = x, P = this;
      for (; C2 > _0n$f || q > _0n$f; )
        C2 & _1n$g && (I = I.add(P)), q & _1n$g && (L = L.add(P)), P = P.double(), C2 >>= _1n$g, q >>= _1n$g;
    ...
    multiply(w) {
      ...
      const { endo: C2 } = e;
      if (C2) {
        const { k1neg: W, k1: q, k2neg: I, k2: L } = C2.splitScalar(x);
        let { p: P, f: ie } = this.wNAF(q), { p: te, f: T } = this.wNAF(L);
        P = k.constTimeNegate(W, P), te = k.constTimeNegate(I, te), te = new y(n.mul(te.px, C2.beta), te.py, te.pz), A = P.add(te), N = ie.add(T);
      } else {
    ...
    multiplyAndAddUnsafe(w, x, A) {
      const N = y.BASE, C2 = (q, I) => I === _0n$f || I === _1n$g || !q.equals(N) ? q.multiplyUnsafe(I) : q.multiply(I), W = C2(this, x).add(C2(w, A));
    ...
    // (x, y, z) ∋ (x=x/z, y=y/z)
    toAffine(w) {
      const { px: x, py: A, pz: N } = this, C2 = this.is0();
      w == null && (w = C2 ? n.ONE : n.inv(N));
...
function weierstrass$3(t) {
  ...
  function a(E2) {
    return _0n$f < E2 && E2 < n.ORDER;
  }
  function c(E2) {
    return mod$3(E2, r);
  }
  function h(E2) {
    return invert$3(E2, r);
  }
  const { ProjectivePoint: p, normPrivateKeyToScalar: g, weierstrassEquation: y, isWithinCurveOrder: $ } = weierstrassPoints$3({
    ...
    fromBytes(E2) {
      const B = E2.length, H = E2[0], Q = E2.subarray(1);
      if (B === s && (H === 2 || H === 3)) {
  ...
  }), k = (E2) => bytesToHex$6(numberToBytesBE$3(E2, e.nByteLength));
  function S(E2) {
    const B = r >> _1n$g;
    return E2 > B;
  }
  ...
  const x = (E2, B, H) => bytesToNumberBE$3(E2.slice(B, H));
  class A {
    constructor(B, H, Q) {
  ...
  const N = {
     ...
     */
    randomPrivateKey: () => {
      const E2 = getMinHashLength$1(e.n);
      return mapHashToField$1(e.randomBytes(E2), e.n);
    },
    /**
     ...
     */
    precompute(E2 = 8, B = p.BASE) {
      return B._setWindowSize(E2), B.multiply(BigInt(3)), B;
    }
  };
  function C2(E2, B = true) {
    return p.fromPrivateKey(E2).toRawBytes(B);
  }
  function W(E2) {
    const B = E2 instanceof Uint8Array, H = typeof E2 == "string", Q = (B || H) && E2.length;
    return B ? Q === s || Q === o : H ? Q === 2 * s || Q === 2 * o : E2 instanceof p;
  }
  function q(E2, B, H = true) {
    if (W(E2))
      throw new Error("first arg must be private key");
    if (!W(B))
      throw new Error("second arg must be public key");
    return p.fromHex(B).multiply(g(E2)).toRawBytes(H);
  }
  const I = e.bits2int || function(E2) {
    const B = bytesToNumberBE$3(E2), H = E2.length * 8 - e.nBitLength;
    return H > 0 ? B >> BigInt(H) : B;
  }, L = e.bits2int_modN || function(E2) {
    return c(I(E2));
  ...
  function ie(E2) {
    ...
    return numberToBytesBE$3(E2, e.nByteLength);
  }
  function te(E2, B, H = T) {
    if (["recovered", "canonical"].some((de) => de in H))
      throw new Error("sign() legacy options not supported");
    const { hash: Q, randomBytes: F } = e;
    let { lowS: ce, prehash: oe, extraEntropy: le } = H;
    ce == null && (ce = true), E2 = ensureBytes$4("msgHash", E2), oe && (E2 = ensureBytes$4("prehashed msgHash", Q(E2)));
    const ve = L(E2), xe = g(B), Se = [ie(xe), ie(ve)];
    if (le != null) {
      const de = le === true ? F(n.BYTES) : le;
  ...
  const T = { lowS: e.lowS, prehash: false }, O = { lowS: e.lowS, prehash: false };
  function K(E2, B, H = T) {
    const { seed: Q, k2sig: F } = te(E2, B, H), ce = e;
    return createHmacDrbg$3(ce.hash.outputLen, ce.nByteLength, ce.hmac)(Q, F);
  }
  p.BASE._setWindowSize(8);
  function ae(E2, B, H, Q = O) {
    var _e;
    const F = E2;
...
var HMAC$6 = class extends Hash$5 {
  constructor(e, n) {
    super(), this.finished = false, this.destroyed = false, hash$6(e);
    const r = toBytes$6(n);
  ...
  digestInto(e) {
    exists$6(this), bytes$7(e, this.outputLen), this.finished = true, this.iHash.digestInto(e), this.oHash.update(e), this.oHash.digestInto(e), this.destroy();
  }
  digest() {
...
var hmac$6 = (t, e, n) => new HMAC$6(t, e).update(n).digest();
...
var secp256k1P$3 = BigInt("0xfffffffffffffffffffffffffffffffffffffffffffffffffffffffefffffc2f");
var secp256k1N$3 = BigInt("0xfffffffffffffffffffffffffffffffebaaedce6af48a03bbfd25e8cd0364141");
var _1n$f = BigInt(1);
var _2n$9 = BigInt(2);
var divNearest$3 = (t, e) => (t + e / _2n$9) / e;
function sqrtMod$3(t) {
  const e = secp256k1P$3, n = BigInt(3), r = BigInt(6), s = BigInt(11), o = BigInt(22), a = BigInt(23), c = BigInt(44), h = BigInt(88), p = t * t * t % e, g = p * p * t % e, y = pow2$3(g, n, e) * g % e, $ = pow2$3(y, n, e) * g % e, k = pow2$3($, _2n$9, e) * p % e, S = pow2$3(k, s, e) * k % e, w = pow2$3(S, o, e) * S % e, x = pow2$3(w, c, e) * w % e, A = pow2$3(x, h, e) * x % e, N = pow2$3(A, c, e) * w % e, C2 = pow2$3(N, n, e) * g % e, W = pow2$3(C2, a, e) * S % e, q = pow2$3(W, r, e) * p % e, I = pow2$3(q, _2n$9, e);
  if (!Fp$3.eql(Fp$3.sqr(I), t))
    throw new Error("Cannot find square root");
  return I;
}
var Fp$3 = Field$3(secp256k1P$3, void 0, void 0, { sqrt: sqrtMod$3 });
var secp256k1$3 = createCurve$3({
  a: BigInt(0),
  b: BigInt(7),
  Fp: Fp$3,
  n: secp256k1N$3,
...
var _0n$e = BigInt(0);
var fe$2 = (t) => typeof t == "bigint" && _0n$e < t && t < secp256k1P$3;
var ge$2 = (t) => typeof t == "bigint" && _0n$e < t && t < secp256k1N$3;
var TAGGED_HASH_PREFIXES$2 = {};
...
var pointToBytes$2 = (t) => t.toRawBytes(true).slice(1);
var numTo32b$2 = (t) => numberToBytesBE$3(t, 32);
var modP$2 = (t) => mod$3(t, secp256k1P$3);
var modN$2 = (t) => mod$3(t, secp256k1N$3);
var Point$3 = secp256k1$3.ProjectivePoint;
var GmulAdd$2 = (t, e, n) => Point$3.BASE.multiplyAndAddUnsafe(t, e, n);
...
var crypto$4 = typeof globalThis == "object" && "crypto" in globalThis ? globalThis.crypto : void 0;
var u8a$5 = (t) => t instanceof Uint8Array;
var createView$4 = (t) => new DataView(t.buffer, t.byteOffset, t.byteLength);
var rotr$4 = (t, e) => t << 32 - e | t >>> e;
var isLE$6 = new Uint8Array(new Uint32Array([287454020]).buffer)[0] === 68;
if (!isLE$6)
  throw new Error("Non little-endian hardware is not supported");
var hexes$5 = Array.from({ length: 256 }, (t, e) => e.toString(16).padStart(2, "0"));
...
var SHA2$4 = class extends Hash$4 {
  constructor(e, n, r, s) {
    super(), this.blockLen = e, this.outputLen = n, this.padOffset = r, this.isLE = s, this.finished = false, this.length = 0, this.pos = 0, this.destroyed = false, this.buffer = new Uint8Array(e), this.view = createView$4(this.buffer);
  }
  update(e) {
  ...
  digestInto(e) {
    assert$4.exists(this), assert$4.output(e, this), this.finished = true;
    const { buffer: n, view: r, blockLen: s, isLE: o } = this;
    let { pos: a } = this;
    n[a++] = 128, this.buffer.subarray(a).fill(0), this.padOffset > s - a && (this.process(r, 0), a = 0);
    for (let y = a; y < s; y++)
...
var Chi$5 = (t, e, n) => t & e ^ ~t & n;
var Maj$5 = (t, e, n) => t & e ^ t & n ^ e & n;
var SHA256_K$5 = new Uint32Array([
  1116352408,
  1899447441,
  3049323471,
  3921009573,
...
var SHA256_W$5 = new Uint32Array(64);
var SHA256$5 = class extends SHA2$4 {
  constructor() {
    super(64, 32, 8, false), this.A = IV$4[0] | 0, this.B = IV$4[1] | 0, this.C = IV$4[2] | 0, this.D = IV$4[3] | 0, this.E = IV$4[4] | 0, this.F = IV$4[5] | 0, this.G = IV$4[6] | 0, this.H = IV$4[7] | 0;
  }
  get() {
    const { A: e, B: n, C: r, D: s, E: o, F: a, G: c, H: h } = this;
    return [e, n, r, s, o, a, c, h];
  ...
  process(e, n) {
    for (let y = 0; y < 16; y++, n += 4)
      SHA256_W$5[y] = e.getUint32(n, false);
    for (let y = 16; y < 64; y++) {
...
var SHA224$2 = class extends SHA256$5 {
  constructor() {
    super(), this.A = -1056596264, this.B = 914150663, this.C = 812702999, this.D = -150054599, this.E = -4191439, this.F = 1750603025, this.G = 1694076839, this.H = -1090891868, this.outputLen = 28;
  }
};
var sha256$5 = wrapConstructor$4(() => new SHA256$5());
...
var gcd$2 = (t, e) => e ? gcd$2(e, t % e) : t;
var radix2carry$2 = (t, e) => t + (e - gcd$2(t, e));
...
var base16$1 = chain$2(radix2$2(4), alphabet$2("0123456789ABCDEF"), join$2(""));
var base32$1 = chain$2(radix2$2(5), alphabet$2("ABCDEFGHIJKLMNOPQRSTUVWXYZ234567"), padding$2(5), join$2(""));
...
var base64$1 = chain$2(radix2$2(6), alphabet$2("ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/"), padding$2(6), join$2(""));
var base64url$1 = chain$2(radix2$2(6), alphabet$2("ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789-_"), padding$2(6), join$2(""));
var genBase58$2 = (t) => chain$2(radix$2(58), alphabet$2(t), join$2(""));
var base58$2 = genBase58$2("123456789ABCDEFGHJKLMNPQRSTUVWXYZabcdefghijkmnopqrstuvwxyz");
...
var XMR_BLOCK_LEN$1 = [0, 2, 3, 5, 6, 7, 9, 10, 11];
var base58xmr$1 = {
  encode(t) {
    let e = "";
...
var BECH_ALPHABET$1 = chain$2(alphabet$2("qpzry9x8gf2tvdw0s3jn54khce6mua7l"), join$2(""));
var POLYMOD_GENERATORS$1 = [996825010, 642813549, 513874426, 1027748829, 705979059];
...
function bechChecksum$1(t, e, n = 1) {
  ...
  for (let o = 0; o < 6; o++)
    s = bech32Polymod$1(s);
  return s ^= n, BECH_ALPHABET$1.encode(convertRadix2$2([s % 2 ** 30], 30, 5, false));
}
function genBech32$1(t) {
  ...
  function c(g, y = 90) {
    ...
    if (g.length < 8 || y !== false && g.length > y)
  ...
  function p(g) {
    const { prefix: y, words: $ } = c(g, false);
...
var bech32$1 = genBech32$1("bech32");
genBech32$1("bech32m");
var utf8$1 = {
  encode: (t) => new TextDecoder().decode(t),
  decode: (t) => new TextEncoder().encode(t)
};
var hex$1 = chain$2(radix2$2(4), alphabet$2("0123456789abcdef"), join$2(""), normalize$3((t) => {
...
var u32$1 = (t) => new Uint32Array(t.buffer, t.byteOffset, Math.floor(t.byteLength / 4));
var isLE$5 = new Uint8Array(new Uint32Array([287454020]).buffer)[0] === 68;
if (!isLE$5)
  throw new Error("Non little-endian hardware is not supported");
...
var wrapCipher = (t, e) => (Object.assign(e, t), e);
var BLOCK_SIZE = 16;
var POLY = 283;
function mul2(t) {
  return t << 1 ^ POLY & -(t >> 7);
...
var invSbox = sbox.map((t, e) => sbox.indexOf(e));
var rotr32_8 = (t) => t << 24 | t >>> 8;
var rotl32_8 = (t) => t << 8 | t >>> 24;
...
var tableEncoding = genTtable(sbox, (t) => mul(t, 3) << 24 | t << 16 | t << 8 | mul(t, 2));
var tableDecoding = genTtable(invSbox, (t) => mul(t, 11) << 24 | mul(t, 13) << 16 | mul(t, 9) << 8 | mul(t, 14));
var xPowers = (() => {
...
var cbc = wrapCipher({ blockSize: 16, nonceLength: 16 }, function(e, n, r = {}) {
  ...
  return {
    ...
    decrypt: (o, a) => {
      ...
      for (let x = 0; x + 4 <= g.length; ) {
        const A = $, N = k, C2 = S, W = w;
        $ = g[x + 0], k = g[x + 1], S = g[x + 2], w = g[x + 3];
        const { s0: q, s1: I, s2: L, s3: P } = decrypt$3(c, $, k, S, w);
        y[x++] = q ^ A, y[x++] = I ^ N, y[x++] = L ^ C2, y[x++] = P ^ W;
      }
      return c.fill(0), validatePCKS(p, s);
    }
  };
});
var sigma16$1 = utf8ToBytes$8("expand 16-byte k");
var sigma32$1 = utf8ToBytes$8("expand 32-byte k");
var sigma16_32$1 = u32$1(sigma16$1);
var sigma32_32$1 = u32$1(sigma32$1);
function rotl$2(t, e) {
  return t << e | t >>> 32 - e;
}
...
function createCipher(t, e) {
  const { allowShortKeys: n, extendNonceFn: r, counterLength: s, counterRight: o, rounds: a } = checkOpts$2({ allowShortKeys: false, counterLength: 8, counterRight: false, rounds: 20 }, e);
  if (typeof t != "function")
  ...
  return number$5(s), number$5(a), bool$4(o), bool$4(n), (c, h, p, g, y = 0) => {
    ...
    const C2 = u32$1(h);
    for (runCipher(t, x, A, C2, p, g, y, a); k.length > 0; )
      k.pop().fill(0);
    return g;
  };
}
function chachaCore$1(t, e, n, r, s, o = 20) {
  let a = t[0], c = t[1], h = t[2], p = t[3], g = e[0], y = e[1], $ = e[2], k = e[3], S = e[4], w = e[5], x = e[6], A = e[7], N = s, C2 = n[0], W = n[1], q = n[2], I = a, L = c, P = h, ie = p, te = g, T = y, O = $, K = k, ae = S, E2 = w, B = x, H = A, Q = N, F = C2, ce = W, oe = q;
  for (let ve = 0; ve < o; ve += 2)
    I = I + te | 0, Q = rotl$2(Q ^ I, 16), ae = ae + Q | 0, te = rotl$2(te ^ ae, 12), I = I + te | 0, Q = rotl$2(Q ^ I, 8), ae = ae + Q | 0, te = rotl$2(te ^ ae, 7), L = L + T | 0, F = rotl$2(F ^ L, 16), E2 = E2 + F | 0, T = rotl$2(T ^ E2, 12), L = L + T | 0, F = rotl$2(F ^ L, 8), E2 = E2 + F | 0, T = rotl$2(T ^ E2, 7), P = P + O | 0, ce = rotl$2(ce ^ P, 16), B = B + ce | 0, O = rotl$2(O ^ B, 12), P = P + O | 0, ce = rotl$2(ce ^ P, 8), B = B + ce | 0, O = rotl$2(O ^ B, 7), ie = ie + K | 0, oe = rotl$2(oe ^ ie, 16), H = H + oe | 0, K = rotl$2(K ^ H, 12), ie = ie + K | 0, oe = rotl$2(oe ^ ie, 8), H = H + oe | 0, K = rotl$2(K ^ H, 7), I = I + T | 0, oe = rotl$2(oe ^ I, 16), B = B + oe | 0, T = rotl$2(T ^ B, 12), I = I + T | 0, oe = rotl$2(oe ^ I, 8), B = B + oe | 0, T = rotl$2(T ^ B, 7), L = L + O | 0, Q = rotl$2(Q ^ L, 16), H = H + Q | 0, O = rotl$2(O ^ H, 12), L = L + O | 0, Q = rotl$2(Q ^ L, 8), H = H + Q | 0, O = rotl$2(O ^ H, 7), P = P + K | 0, F = rotl$2(F ^ P, 16), ae = ae + F | 0, K = rotl$2(K ^ ae, 12), P = P + K | 0, F = rotl$2(F ^ P, 8), ae = ae + F | 0, K = rotl$2(K ^ ae, 7), ie = ie + te | 0, ce = rotl$2(ce ^ ie, 16), E2 = E2 + ce | 0, te = rotl$2(te ^ E2, 12), ie = ie + te | 0, ce = rotl$2(ce ^ ie, 8), E2 = E2 + ce | 0, te = rotl$2(te ^ E2, 7);
  let le = 0;
  r[le++] = a + I | 0, r[le++] = c + L | 0, r[le++] = h + P | 0, r[le++] = p + ie | 0, r[le++] = g + te | 0, r[le++] = y + T | 0, r[le++] = $ + O | 0, r[le++] = k + K | 0, r[le++] = S + ae | 0, r[le++] = w + E2 | 0, r[le++] = x + B | 0, r[le++] = A + H | 0, r[le++] = N + Q | 0, r[le++] = C2 + F | 0, r[le++] = W + ce | 0, r[le++] = q + oe | 0;
}
var chacha20$1 = createCipher(chachaCore$1, {
  counterRight: false,
  counterLength: 4,
  allowShortKeys: false
});
var HMAC$5 = class extends Hash$4 {
  constructor(e, n) {
    super(), this.finished = false, this.destroyed = false, assert$4.hash(e);
    const r = toBytes$5(n);
    if (this.iHash = e.create(), typeof this.iHash.update != "function")
      throw new Error("Expected instance of class which extends utils.Hash");
    this.blockLen = this.iHash.blockLen, this.outputLen = this.iHash.outputLen;
  ...
  digestInto(e) {
    assert$4.exists(this), assert$4.bytes(e, this.outputLen), this.finished = true, this.iHash.digestInto(e), this.oHash.update(e), this.oHash.digestInto(e), this.destroy();
  }
  digest() {
    const e = new Uint8Array(this.oHash.outputLen);
    return this.digestInto(e), e;
...
var hmac$5 = (t, e, n) => new HMAC$5(t, e).update(n).digest();
hmac$5.create = (t, e) => new HMAC$5(t, e);
function extract$1(t, e, n) {
  return assert$4.hash(t), hmac$5(t, toBytes$5(n), toBytes$5(e));
}
var HKDF_COUNTER$1 = new Uint8Array([0]);
var EMPTY_BUFFER$1 = new Uint8Array();
...
var __defNormalProp = (t, e, n) => e in t ? __defProp$1(t, e, { enumerable: true, configurable: true, writable: true, value: n }) : t[e] = n;
var __export$1 = (t, e) => {
  for (var n in e)
    __defProp$1(t, n, { get: e[n], enumerable: true });
};
var __publicField = (t, e, n) => (__defNormalProp(t, typeof e != "symbol" ? e + "" : e, n), n);
var verifiedSymbol$1 = Symbol("verified");
var isRecord$1 = (t) => t instanceof Object;
...
var Queue$1 = class {
  ...
  enqueue(e) {
    ...
    return this.last ? this.last === this.first ? (this.last = n, this.last.prev = this.first, this.first.next = n) : (n.prev = this.last, this.last.next = n, this.last = n) : (this.first = n, this.last = n), true;
  }
  dequeue() {
    if (!this.first)
      return null;
...
var JS = class {
  ...
  finalizeEvent(t, e) {
    const n = t;
    return n.pubkey = bytesToHex$5(schnorr$2.getPublicKey(e)), n.id = getEventHash$2(n), n.sig = bytesToHex$5(schnorr$2.sign(getEventHash$2(n), e)), n[verifiedSymbol$1] = true, n;
  }
  verifyEvent(t) {
    ...
    if (e !== t.id)
      return t[verifiedSymbol$1] = false, false;
    try {
...
function naddrEncode$1(t) {
  ...
  new DataView(e).setUint32(0, t.kind, false);
  let n = encodeTLV$1({
...
var channelMetadataEvent$1 = (t, e) => {
  let n;
  if (typeof t.content == "object")
    n = JSON.stringify(t.content);
  else if (typeof t.content == "string")
...
var channelHideMessageEvent$1 = (t, e) => {
  let n;
  if (typeof t.content == "object")
    n = JSON.stringify(t.content);
  else if (typeof t.content == "string")
...
var channelMuteUserEvent$1 = (t, e) => {
  let n;
  if (typeof t.content == "object")
    n = JSON.stringify(t.content);
  else if (typeof t.content == "string")
...
var _u = class {
  ...
  static writeU16BE(t) {
    ...
    return new DataView(e.buffer).setUint16(0, t, false), e;
  }
  static pad(t) {
...
async function getToken$1(t, e, n, r = false, s) {
  const o = {
    kind: HTTPAuth,
    tags: [
      ["u", t],
...
function validateEventTimestamp(t) {
  return t.created_at ? Math.round((/* @__PURE__ */ new Date()).getTime() / 1e3) - t.created_at < 60 : false;
}
...
function validateEventUrlTag(t, e) {
  ...
  return n ? n.length > 0 && n[1] === e : false;
}
function validateEventMethodTag(t, e) {
  const n = t.tags.find((r) => r[0] === "method");
  return n ? n.length > 0 && n[1].toLowerCase() === e.toLowerCase() : false;
}
...
var PublicKey = class _PublicKey extends Hex {
  /**
...
var u8a$4 = (t) => t instanceof Uint8Array;
var createView$3 = (t) => new DataView(t.buffer, t.byteOffset, t.byteLength);
var rotr$3 = (t, e) => t << 32 - e | t >>> e;
var isLE$4 = new Uint8Array(new Uint32Array([287454020]).buffer)[0] === 68;
if (!isLE$4)
  throw new Error("Non little-endian hardware is not supported");
var hexes$4 = Array.from({ length: 256 }, (t, e) => e.toString(16).padStart(2, "0"));
...
var SHA2$3 = class extends Hash$3 {
  constructor(e, n, r, s) {
    super(), this.blockLen = e, this.outputLen = n, this.padOffset = r, this.isLE = s, this.finished = false, this.length = 0, this.pos = 0, this.destroyed = false, this.buffer = new Uint8Array(e), this.view = createView$3(this.buffer);
  }
  update(e) {
  ...
  digestInto(e) {
    assert$3.exists(this), assert$3.output(e, this), this.finished = true;
    const { buffer: n, view: r, blockLen: s, isLE: o } = this;
    let { pos: a } = this;
    n[a++] = 128, this.buffer.subarray(a).fill(0), this.padOffset > s - a && (this.process(r, 0), a = 0);
    for (let y = a; y < s; y++)
...
var Chi$4 = (t, e, n) => t & e ^ ~t & n;
var Maj$4 = (t, e, n) => t & e ^ t & n ^ e & n;
var SHA256_K$4 = new Uint32Array([
  1116352408,
  1899447441,
  3049323471,
  3921009573,
...
var SHA256_W$4 = new Uint32Array(64);
var SHA256$4 = class extends SHA2$3 {
  constructor() {
    super(64, 32, 8, false), this.A = IV$3[0] | 0, this.B = IV$3[1] | 0, this.C = IV$3[2] | 0, this.D = IV$3[3] | 0, this.E = IV$3[4] | 0, this.F = IV$3[5] | 0, this.G = IV$3[6] | 0, this.H = IV$3[7] | 0;
  }
  get() {
    const { A: e, B: n, C: r, D: s, E: o, F: a, G: c, H: h } = this;
    return [e, n, r, s, o, a, c, h];
  ...
  process(e, n) {
    for (let y = 0; y < 16; y++, n += 4)
      SHA256_W$4[y] = e.getUint32(n, false);
    for (let y = 16; y < 64; y++) {
...
var SHA224$1 = class extends SHA256$4 {
  constructor() {
    super(), this.A = -1056596264, this.B = 914150663, this.C = 812702999, this.D = -150054599, this.E = -4191439, this.F = 1750603025, this.G = 1694076839, this.H = -1090891868, this.outputLen = 28;
  }
};
var sha256$4 = wrapConstructor$3(() => new SHA256$4());
wrapConstructor$3(() => new SHA224$1());
var _0n$d = BigInt(0);
var _1n$e = BigInt(1);
var _2n$8 = BigInt(2);
var u8a$3 = (t) => t instanceof Uint8Array;
var hexes$3 = Array.from({ length: 256 }, (t, e) => e.toString(16).padStart(2, "0"));
...
var bitSet$2 = (t, e, n) => t | (n ? _1n$e : _0n$d) << BigInt(e);
var bitMask$2 = (t) => (_2n$8 << BigInt(t - 1)) - _1n$e;
var u8n$2 = (t) => new Uint8Array(t);
var u8fr$2 = (t) => Uint8Array.from(t);
...
var ut$2 = Object.freeze(Object.defineProperty({
  __proto__: null,
  bitGet: bitGet$2,
  bitLen: bitLen$2,
  bitMask: bitMask$2,
...
function Field$2(t, e, n = false, r = {}) {
  if (t <= _0n$c)
...
function hashToPrivateScalar$1(t, e, n = false) {
...
var { bytesToNumberBE: b2n$2, hexToBytes: h2b$2 } = ut$2;
var DER$2 = {
  // asn.1 DER encoding utils
  Err: class extends Error {
    constructor(e = "") {
...
function weierstrassPoints$2(t) {
  ...
  function h(S) {
    ...
    let C2;
    try {
      C2 = typeof S == "bigint" ? S : bytesToNumberBE$2(ensureBytes$3("private key", S, x));
    } catch {
      throw new Error(`private key must be ${x} bytes, hex or bigint, not ${typeof S}`);
    }
    return A && (C2 = mod$2(C2, N)), c(C2), C2;
  }
  const p = /* @__PURE__ */ new Map();
  function g(S) {
    if (!(S instanceof y))
  ...
  class y {
    ...
    // Cost: 8M + 3S + 3*a + 2*b3 + 15add.
    double() {
      const { a: w, b: x } = e, A = n.mul(x, _3n$4), { px: N, py: C2, pz: W } = this;
      let q = n.ZERO, I = n.ZERO, L = n.ZERO, P = n.mul(N, N), ie = n.mul(C2, C2), te = n.mul(W, W), T = n.mul(N, C2);
      return T = n.add(T, T), L = n.mul(N, W), L = n.add(L, L), q = n.mul(w, L), I = n.mul(A, te), I = n.add(q, I), q = n.sub(ie, I), I = n.add(ie, I), I = n.mul(q, I), q = n.mul(T, q), L = n.mul(A, L), te = n.mul(w, te), T = n.sub(P, te), T = n.mul(w, T), T = n.add(T, L), L = n.add(P, P), P = n.add(L, P), P = n.add(P, te), P = n.mul(P, T), I = n.add(I, P), te = n.mul(C2, W), te = n.add(te, te), P = n.mul(te, T), q = n.sub(q, P), L = n.mul(te, ie), L = n.add(L, L), L = n.add(L, L), new y(q, I, L);
    }
    // Renes-Costello-Batina exception-free addition formula.
    ...
    multiplyUnsafe(w) {
      ...
      if (!A)
        return k.unsafeLadder(this, w);
      let { k1neg: N, k1: C2, k2neg: W, k2: q } = A.splitScalar(w), I = x, L = x, P = this;
      for (; C2 > _0n$a || q > _0n$a; )
        C2 & _1n$b && (I = I.add(P)), q & _1n$b && (L = L.add(P)), P = P.double(), C2 >>= _1n$b, q >>= _1n$b;
      return N && (I = I.negate()), W && (L = L.negate()), L = new y(n.mul(L.px, A.beta), L.py, L.pz), I.add(L);
    }
    /**
     * Constant time multiplication.
     ...
     */
    multiplyAndAddUnsafe(w, x, A) {
      const N = y.BASE, C2 = (q, I) => I === _0n$a || I === _1n$b || !q.equals(N) ? q.multiplyUnsafe(I) : q.multiply(I), W = C2(this, x).add(C2(w, A));
      return W.is0() ? void 0 : W;
    }
    // Converts Projective point to affine (x, y) coordinates.
    // Can accept precomputed Z^-1 - for example, from invertBatch.
...
function weierstrass$2(t) {
  ...
  function a(E2) {
    return _0n$a < E2 && E2 < n.ORDER;
  }
  function c(E2) {
    return mod$2(E2, r);
  }
  function h(E2) {
    return invert$2(E2, r);
  }
  ...
  }), k = (E2) => bytesToHex$3(numberToBytesBE$2(E2, e.nByteLength));
  function S(E2) {
    const B = r >> _1n$b;
    return E2 > B;
  }
  ...
  const x = (E2, B, H) => bytesToNumberBE$2(E2.slice(B, H));
  class A {
    constructor(B, H, Q) {
      this.r = B, this.s = H, this.recovery = Q, this.assertValidity();
    }
  ...
  const N = {
     ...
     */
    randomPrivateKey: () => {
      const E2 = e.randomBytes(n.BYTES + 8), B = hashToPrivateScalar$1(E2, r);
  ...
  const I = e.bits2int || function(E2) {
    const B = bytesToNumberBE$2(E2), H = E2.length * 8 - e.nBitLength;
    return H > 0 ? B >> BigInt(H) : B;
  }, L = e.bits2int_modN || function(E2) {
    return c(I(E2));
  ...
  function ie(E2) {
    ...
    if (!(_0n$a <= E2 && E2 < P))
      throw new Error(`bigint expected < 2^${e.nBitLength}`);
    return numberToBytesBE$2(E2, e.nByteLength);
  }
  function te(E2, B, H = T) {
    if (["recovered", "canonical"].some((de) => de in H))
      throw new Error("sign() legacy options not supported");
    const { hash: Q, randomBytes: F } = e;
    let { lowS: ce, prehash: oe, extraEntropy: le } = H;
    ce == null && (ce = true), E2 = ensureBytes$3("msgHash", E2), oe && (E2 = ensureBytes$3("prehashed msgHash", Q(E2)));
    const ve = L(E2), xe = g(B), Se = [ie(xe), ie(ve)];
    if (le != null) {
      const de = le === true ? F(n.BYTES) : le;
...
var HMAC$4 = class extends Hash$3 {
  constructor(e, n) {
    super(), this.finished = false, this.destroyed = false, assert$3.hash(e);
    const r = toBytes$4(n);
    if (this.iHash = e.create(), typeof this.iHash.update != "function")
      throw new Error("Expected instance of class which extends utils.Hash");
    this.blockLen = this.iHash.blockLen, this.outputLen = this.iHash.outputLen;
  ...
  digestInto(e) {
    assert$3.exists(this), assert$3.bytes(e, this.outputLen), this.finished = true, this.iHash.digestInto(e), this.oHash.update(e), this.oHash.digestInto(e), this.destroy();
  }
  digest() {
    const e = new Uint8Array(this.oHash.outputLen);
    return this.digestInto(e), e;
...
var hmac$4 = (t, e, n) => new HMAC$4(t, e).update(n).digest();
...
var secp256k1P$2 = BigInt("0xfffffffffffffffffffffffffffffffffffffffffffffffffffffffefffffc2f");
var secp256k1N$2 = BigInt("0xfffffffffffffffffffffffffffffffebaaedce6af48a03bbfd25e8cd0364141");
var _1n$a = BigInt(1);
var _2n$6 = BigInt(2);
var divNearest$2 = (t, e) => (t + e / _2n$6) / e;
function sqrtMod$2(t) {
  const e = secp256k1P$2, n = BigInt(3), r = BigInt(6), s = BigInt(11), o = BigInt(22), a = BigInt(23), c = BigInt(44), h = BigInt(88), p = t * t * t % e, g = p * p * t % e, y = pow2$2(g, n, e) * g % e, $ = pow2$2(y, n, e) * g % e, k = pow2$2($, _2n$6, e) * p % e, S = pow2$2(k, s, e) * k % e, w = pow2$2(S, o, e) * S % e, x = pow2$2(w, c, e) * w % e, A = pow2$2(x, h, e) * x % e, N = pow2$2(A, c, e) * w % e, C2 = pow2$2(N, n, e) * g % e, W = pow2$2(C2, a, e) * S % e, q = pow2$2(W, r, e) * p % e, I = pow2$2(q, _2n$6, e);
  if (!Fp$2.eql(Fp$2.sqr(I), t))
    throw new Error("Cannot find square root");
  return I;
}
var Fp$2 = Field$2(secp256k1P$2, void 0, void 0, { sqrt: sqrtMod$2 });
var secp256k1$2 = createCurve$2({
  a: BigInt(0),
  b: BigInt(7),
  Fp: Fp$2,
  n: secp256k1N$2,
...
var _0n$9 = BigInt(0);
var fe$1 = (t) => typeof t == "bigint" && _0n$9 < t && t < secp256k1P$2;
var ge$1 = (t) => typeof t == "bigint" && _0n$9 < t && t < secp256k1N$2;
var TAGGED_HASH_PREFIXES$1 = {};
...
var pointToBytes$1 = (t) => t.toRawBytes(true).slice(1);
var numTo32b$1 = (t) => numberToBytesBE$2(t, 32);
var modP$1 = (t) => mod$2(t, secp256k1P$2);
var modN$1 = (t) => mod$2(t, secp256k1N$2);
var Point$2 = secp256k1$2.ProjectivePoint;
var GmulAdd$1 = (t, e, n) => Point$2.BASE.multiplyAndAddUnsafe(t, e, n);
...
var gcd$1 = (t, e) => e ? gcd$1(e, t % e) : t;
var radix2carry$1 = (t, e) => t + (e - gcd$1(t, e));
...
var base16 = chain$1(radix2$1(4), alphabet$1("0123456789ABCDEF"), join$1(""));
var base32 = chain$1(radix2$1(5), alphabet$1("ABCDEFGHIJKLMNOPQRSTUVWXYZ234567"), padding$1(5), join$1(""));
...
var base64 = chain$1(radix2$1(6), alphabet$1("ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/"), padding$1(6), join$1(""));
var base64url = chain$1(radix2$1(6), alphabet$1("ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789-_"), padding$1(6), join$1(""));
var genBase58$1 = (t) => chain$1(radix$1(58), alphabet$1(t), join$1(""));
var base58$1 = genBase58$1("123456789ABCDEFGHJKLMNPQRSTUVWXYZabcdefghijkmnopqrstuvwxyz");
...
var BECH_ALPHABET = chain$1(alphabet$1("qpzry9x8gf2tvdw0s3jn54khce6mua7l"), join$1(""));
...
function bechChecksum(t, e, n = 1) {
  ...
  for (let o = 0; o < 6; o++)
    s = bech32Polymod(s);
  return s ^= n, BECH_ALPHABET.encode(convertRadix2$1([s % 2 ** 30], 30, 5, false));
}
...
var hex = chain$1(radix2$1(4), alphabet$1("0123456789abcdef"), join$1(""), normalize$2((t) => {
  if (typeof t != "string" || t.length % 2)
    throw new TypeError(`hex.decode: expected string, got ${typeof t} with length ${t.length}`);
  return t.toLowerCase();
}));
...
var assert$2 = { number: number$3, bool: bool$2, bytes: bytes$3, hash: hash$3, exists: exists$3, output: output$3 };
var crypto$2 = typeof globalThis == "object" && "crypto" in globalThis ? globalThis.crypto : void 0;
function isBytes$4(t) {
  return t instanceof Uint8Array || t != null && typeof t == "object" && t.constructor.name === "Uint8Array";
}
var createView$2 = (t) => new DataView(t.buffer, t.byteOffset, t.byteLength);
var rotr$2 = (t, e) => t << 32 - e | t >>> e;
var isLE$3 = new Uint8Array(new Uint32Array([287454020]).buffer)[0] === 68;
if (!isLE$3)
  throw new Error("Non little-endian hardware is not supported");
...
var HMAC$3 = class extends Hash$2 {
  constructor(e, n) {
    super(), this.finished = false, this.destroyed = false, hash$3(e);
    const r = toBytes$3(n);
    if (this.iHash = e.create(), typeof this.iHash.update != "function")
      throw new Error("Expected instance of class which extends utils.Hash");
    this.blockLen = this.iHash.blockLen, this.outputLen = this.iHash.outputLen;
  ...
  digestInto(e) {
    exists$3(this), bytes$3(e, this.outputLen), this.finished = true, this.iHash.digestInto(e), this.oHash.update(e), this.oHash.digestInto(e), this.destroy();
  }
  digest() {
    const e = new Uint8Array(this.oHash.outputLen);
    return this.digestInto(e), e;
...
var hmac$3 = (t, e, n) => new HMAC$3(t, e).update(n).digest();
...
function pbkdf2(t, e, n, r) {
  ...
  for (let k = 1, S = 0; S < o; k++, S += c.outputLen) {
    ...
    y.setInt32(0, k, false), (p = h._cloneInto(p)).update(g).digestInto($), w.set($.subarray(0, w.length));
    for (let x = 1; x < s; x++) {
...
var SHA2$2 = class extends Hash$2 {
  constructor(e, n, r, s) {
    super(), this.blockLen = e, this.outputLen = n, this.padOffset = r, this.isLE = s, this.finished = false, this.length = 0, this.pos = 0, this.destroyed = false, this.buffer = new Uint8Array(e), this.view = createView$2(this.buffer);
  }
  update(e) {
    exists$3(this);
    const { view: n, buffer: r, blockLen: s } = this;
  ...
  digestInto(e) {
    exists$3(this), output$3(e, this), this.finished = true;
    const { buffer: n, view: r, blockLen: s, isLE: o } = this;
    let { pos: a } = this;
    n[a++] = 128, this.buffer.subarray(a).fill(0), this.padOffset > s - a && (this.process(r, 0), a = 0);
    for (let y = a; y < s; y++)
...
var Chi$3 = (t, e, n) => t & e ^ ~t & n;
var Maj$3 = (t, e, n) => t & e ^ t & n ^ e & n;
var SHA256_K$3 = new Uint32Array([
  1116352408,
  1899447441,
  3049323471,
  3921009573,
...
var SHA256_W$3 = new Uint32Array(64);
var SHA256$3 = class extends SHA2$2 {
  constructor() {
    super(64, 32, 8, false), this.A = IV$2[0] | 0, this.B = IV$2[1] | 0, this.C = IV$2[2] | 0, this.D = IV$2[3] | 0, this.E = IV$2[4] | 0, this.F = IV$2[5] | 0, this.G = IV$2[6] | 0, this.H = IV$2[7] | 0;
  }
  get() {
    const { A: e, B: n, C: r, D: s, E: o, F: a, G: c, H: h } = this;
    return [e, n, r, s, o, a, c, h];
  ...
  process(e, n) {
    for (let y = 0; y < 16; y++, n += 4)
      SHA256_W$3[y] = e.getUint32(n, false);
    for (let y = 16; y < 64; y++) {
...
var sha256$3 = wrapConstructor$2(() => new SHA256$3());
var U32_MASK64$1 = BigInt(2 ** 32 - 1);
var _32n$1 = BigInt(32);
function fromBig$1(t, e = false) {
...
var toBig$1 = (t, e) => BigInt(t >>> 0) << _32n$1 | BigInt(e >>> 0);
var shrSH$1 = (t, e, n) => t >>> n;
var shrSL$1 = (t, e, n) => t << 32 - n | e >>> n;
var rotrSH$1 = (t, e, n) => t >>> n | e << 32 - n;
var rotrSL$1 = (t, e, n) => t << 32 - n | e >>> n;
var rotrBH$1 = (t, e, n) => t << 64 - n | e >>> n - 32;
var rotrBL$1 = (t, e, n) => t >>> n - 32 | e << 64 - n;
var rotr32H$1 = (t, e) => e;
var rotr32L$1 = (t, e) => t;
var rotlSH$1 = (t, e, n) => t << n | e >>> 32 - n;
var rotlSL$1 = (t, e, n) => e << n | t >>> 32 - n;
var rotlBH$1 = (t, e, n) => e << n - 32 | t >>> 64 - n;
var rotlBL$1 = (t, e, n) => t << n - 32 | e >>> 64 - n;
function add$1(t, e, n, r) {
  const s = (e >>> 0) + (r >>> 0);
  return { h: t + n + (s / 2 ** 32 | 0) | 0, l: s | 0 };
}
var add3L$1 = (t, e, n) => (t >>> 0) + (e >>> 0) + (n >>> 0);
var add3H$1 = (t, e, n, r) => e + n + r + (t / 2 ** 32 | 0) | 0;
var add4L$1 = (t, e, n, r) => (t >>> 0) + (e >>> 0) + (n >>> 0) + (r >>> 0);
var add4H$1 = (t, e, n, r, s) => e + n + r + s + (t / 2 ** 32 | 0) | 0;
var add5L$1 = (t, e, n, r, s) => (t >>> 0) + (e >>> 0) + (n >>> 0) + (r >>> 0) + (s >>> 0);
var add5H$1 = (t, e, n, r, s, o) => e + n + r + s + o + (t / 2 ** 32 | 0) | 0;
var u64$1 = {
  fromBig: fromBig$1,
  split: split$1,
  toBig: toBig$1,
...
var [SHA512_Kh$1, SHA512_Kl$1] = u64$1.split([
  "0x428a2f98d728ae22",
  "0x7137449123ef65cd",
  "0xb5c0fbcfec4d3b2f",
  "0xe9b5dba58189dbbc",
...
var SHA512_W_H$1 = new Uint32Array(80);
var SHA512_W_L$1 = new Uint32Array(80);
var SHA512$1 = class extends SHA2$2 {
  constructor() {
  ...
  process(e, n) {
    for (let C2 = 0; C2 < 16; C2++, n += 4)
      SHA512_W_H$1[C2] = e.getUint32(n), SHA512_W_L$1[C2] = e.getUint32(n += 4);
    for (let C2 = 16; C2 < 80; C2++) {
      const W = SHA512_W_H$1[C2 - 15] | 0, q = SHA512_W_L$1[C2 - 15] | 0, I = u64$1.rotrSH(W, q, 1) ^ u64$1.rotrSH(W, q, 8) ^ u64$1.shrSH(W, q, 7), L = u64$1.rotrSL(W, q, 1) ^ u64$1.rotrSL(W, q, 8) ^ u64$1.shrSL(W, q, 7), P = SHA512_W_H$1[C2 - 2] | 0, ie = SHA512_W_L$1[C2 - 2] | 0, te = u64$1.rotrSH(P, ie, 19) ^ u64$1.rotrBH(P, ie, 61) ^ u64$1.shrSH(P, ie, 6), T = u64$1.rotrSL(P, ie, 19) ^ u64$1.rotrBL(P, ie, 61) ^ u64$1.shrSL(P, ie, 6), O = u64$1.add4L(L, T, SHA512_W_L$1[C2 - 7], SHA512_W_L$1[C2 - 16]), K = u64$1.add4H(O, I, te, SHA512_W_H$1[C2 - 7], SHA512_W_H$1[C2 - 16]);
      SHA512_W_H$1[C2] = K | 0, SHA512_W_L$1[C2] = O | 0;
    }
    let { Ah: r, Al: s, Bh: o, Bl: a, Ch: c, Cl: h, Dh: p, Dl: g, Eh: y, El: $, Fh: k, Fl: S, Gh: w, Gl: x, Hh: A, Hl: N } = this;
    for (let C2 = 0; C2 < 80; C2++) {
      const W = u64$1.rotrSH(y, $, 14) ^ u64$1.rotrSH(y, $, 18) ^ u64$1.rotrBH(y, $, 41), q = u64$1.rotrSL(y, $, 14) ^ u64$1.rotrSL(y, $, 18) ^ u64$1.rotrBL(y, $, 41), I = y & k ^ ~y & w, L = $ & S ^ ~$ & x, P = u64$1.add5L(N, q, L, SHA512_Kl$1[C2], SHA512_W_L$1[C2]), ie = u64$1.add5H(P, A, W, I, SHA512_Kh$1[C2], SHA512_W_H$1[C2]), te = P | 0, T = u64$1.rotrSH(r, s, 28) ^ u64$1.rotrBH(r, s, 34) ^ u64$1.rotrBH(r, s, 39), O = u64$1.rotrSL(r, s, 28) ^ u64$1.rotrBL(r, s, 34) ^ u64$1.rotrBL(r, s, 39), K = r & o ^ r & c ^ o & c, ae = s & a ^ s & h ^ a & h;
      A = w | 0, N = x | 0, w = k | 0, x = S | 0, k = y | 0, S = $ | 0, { h: y, l: $ } = u64$1.add(p | 0, g | 0, ie | 0, te | 0), p = c | 0, g = h | 0, c = o | 0, h = a | 0, o = r | 0, a = s | 0;
      const E2 = u64$1.add3L(te, O, ae);
      r = u64$1.add3H(E2, ie, T, K), s = E2 | 0;
    }
...
var sha512$1 = wrapConstructor$2(() => new SHA512$1());
...
var gcd = (t, e) => e ? gcd(e, t % e) : t;
var radix2carry = (t, e) => t + (e - gcd(t, e));
function convertRadix2(t, e, n, r) {
  ...
  if (n <= 0 || n > 32)
    throw new Error(`convertRadix2: wrong to=${n}`);
  if (radix2carry(e, n) > 32)
    throw new Error(`convertRadix2: carry overflow from=${e} to=${n} carryBits=${radix2carry(e, n)}`);
  let s = 0, o = 0;
  const a = 2 ** n - 1, c = [];
  for (const h of t) {
    if (h >= 2 ** e)
...
function radix(t) {
  return {
    encode: (e) => {
      if (!isBytes$3(e))
        throw new Error("radix.encode input should be Uint8Array");
      return convertRadix(Array.from(e), 2 ** 8, t);
    },
    decode: (e) => {
      if (!Array.isArray(e) || e.length && typeof e[0] != "number")
        throw new Error("radix.decode input should be array of numbers");
      return Uint8Array.from(convertRadix(e, t, 2 ** 8));
    }
  };
}
function radix2(t, e = false) {
  if (t <= 0 || t > 32)
    throw new Error("radix2: bits should be in (0..32]");
  if (radix2carry(8, t) > 32 || radix2carry(t, 8) > 32)
    throw new Error("radix2: carry overflow");
  return {
    encode: (n) => {
      if (!isBytes$3(n))
        throw new Error("radix2.encode input should be Uint8Array");
      return convertRadix2(Array.from(n), 8, t, !e);
    },
    decode: (n) => {
      if (!Array.isArray(n) || n.length && typeof n[0] != "number")
        throw new Error("radix2.decode input should be array of numbers");
      return Uint8Array.from(convertRadix2(n, t, 8, e));
    }
  };
}
...
var genBase58 = (t) => chain(radix(58), alphabet(t), join(""));
var base58 = genBase58("123456789ABCDEFGHJKLMNPQRSTUVWXYZabcdefghijkmnopqrstuvwxyz");
var createBase58check = (t) => chain(checksum(4, (e) => t(t(e))), base58);
var base58check$1 = createBase58check;
var isJapanese = (t) => t[0] === "あいこくしん";
function nfkd(t) {
  if (typeof t != "string")
...
function getCoder(t) {
  ...
  }), utils$2.chain(utils$2.checksum(1, calcChecksum), utils$2.radix2(11, true), utils$2.alphabet(t));
}
...
var createView$1 = (t) => new DataView(t.buffer, t.byteOffset, t.byteLength);
var rotr$1 = (t, e) => t << 32 - e | t >>> e;
var isLE$2 = new Uint8Array(new Uint32Array([287454020]).buffer)[0] === 68;
if (!isLE$2)
  throw new Error("Non little-endian hardware is not supported");
var hexes$2 = Array.from({ length: 256 }, (t, e) => e.toString(16).padStart(2, "0"));
...
var asciis$1 = { _0: 48, _9: 57, _A: 65, _F: 70, _a: 97, _f: 102 };
...
var HMAC$2 = class extends Hash$1 {
  constructor(e, n) {
    super(), this.finished = false, this.destroyed = false, hash$2(e);
    const r = toBytes$2(n);
    if (this.iHash = e.create(), typeof this.iHash.update != "function")
      throw new Error("Expected instance of class which extends utils.Hash");
    this.blockLen = this.iHash.blockLen, this.outputLen = this.iHash.outputLen;
  ...
  digestInto(e) {
    exists$2(this), bytes$2(e, this.outputLen), this.finished = true, this.iHash.digestInto(e), this.oHash.update(e), this.oHash.digestInto(e), this.destroy();
  }
  digest() {
    const e = new Uint8Array(this.oHash.outputLen);
    return this.digestInto(e), e;
...
var hmac$2 = (t, e, n) => new HMAC$2(t, e).update(n).digest();
...
var SHA2$1 = class extends Hash$1 {
  constructor(e, n, r, s) {
    super(), this.blockLen = e, this.outputLen = n, this.padOffset = r, this.isLE = s, this.finished = false, this.length = 0, this.pos = 0, this.destroyed = false, this.buffer = new Uint8Array(e), this.view = createView$1(this.buffer);
  }
  update(e) {
    exists$2(this);
    const { view: n, buffer: r, blockLen: s } = this;
  ...
  digestInto(e) {
    exists$2(this), output$2(e, this), this.finished = true;
    const { buffer: n, view: r, blockLen: s, isLE: o } = this;
    let { pos: a } = this;
    n[a++] = 128, this.buffer.subarray(a).fill(0), this.padOffset > s - a && (this.process(r, 0), a = 0);
    for (let y = a; y < s; y++)
...
var Id = Uint8Array.from({ length: 16 }, (t, e) => e);
var Pi = Id.map((t) => (9 * t + 5) % 16);
var idxL = [Id];
var idxR = [Pi];
for (let t = 0; t < 4; t++)
...
var shiftsL = idxL.map((t, e) => t.map((n) => shifts[e][n]));
var shiftsR = idxR.map((t, e) => t.map((n) => shifts[e][n]));
...
var RIPEMD160 = class extends SHA2$1 {
  ...
  process(e, n) {
    for (let k = 0; k < 16; k++, n += 4)
      BUF[k] = e.getUint32(n, true);
    let r = this.h0 | 0, s = r, o = this.h1 | 0, a = o, c = this.h2 | 0, h = c, p = this.h3 | 0, g = p, y = this.h4 | 0, $ = y;
    for (let k = 0; k < 5; k++) {
      const S = 4 - k, w = Kl[k], x = Kr[k], A = idxL[k], N = idxR[k], C2 = shiftsL[k], W = shiftsR[k];
      for (let q = 0; q < 16; q++) {
        const I = rotl$1(r + f(k, o, c, p) + BUF[A[q]] + w, C2[q]) + y | 0;
...
var ripemd160 = wrapConstructor$1(() => new RIPEMD160());
var Chi$2 = (t, e, n) => t & e ^ ~t & n;
var Maj$2 = (t, e, n) => t & e ^ t & n ^ e & n;
var SHA256_K$2 = new Uint32Array([
  1116352408,
  1899447441,
  3049323471,
  3921009573,
...
var SHA256_W$2 = new Uint32Array(64);
var SHA256$2 = class extends SHA2$1 {
  constructor() {
    super(64, 32, 8, false), this.A = IV$1[0] | 0, this.B = IV$1[1] | 0, this.C = IV$1[2] | 0, this.D = IV$1[3] | 0, this.E = IV$1[4] | 0, this.F = IV$1[5] | 0, this.G = IV$1[6] | 0, this.H = IV$1[7] | 0;
  }
  get() {
    const { A: e, B: n, C: r, D: s, E: o, F: a, G: c, H: h } = this;
    return [e, n, r, s, o, a, c, h];
  ...
  process(e, n) {
    for (let y = 0; y < 16; y++, n += 4)
      SHA256_W$2[y] = e.getUint32(n, false);
    for (let y = 16; y < 64; y++) {
...
var toBig = (t, e) => BigInt(t >>> 0) << _32n | BigInt(e >>> 0);
var shrSH = (t, e, n) => t >>> n;
var shrSL = (t, e, n) => t << 32 - n | e >>> n;
var rotrSH = (t, e, n) => t >>> n | e << 32 - n;
var rotrSL = (t, e, n) => t << 32 - n | e >>> n;
var rotrBH = (t, e, n) => t << 64 - n | e >>> n - 32;
var rotrBL = (t, e, n) => t >>> n - 32 | e << 64 - n;
var rotr32H = (t, e) => e;
var rotr32L = (t, e) => t;
var rotlSH = (t, e, n) => t << n | e >>> 32 - n;
var rotlSL = (t, e, n) => e << n | t >>> 32 - n;
var rotlBH = (t, e, n) => e << n - 32 | t >>> 64 - n;
var rotlBL = (t, e, n) => t << n - 32 | e >>> 64 - n;
function add(t, e, n, r) {
  const s = (e >>> 0) + (r >>> 0);
  return { h: t + n + (s / 2 ** 32 | 0) | 0, l: s | 0 };
}
var add3L = (t, e, n) => (t >>> 0) + (e >>> 0) + (n >>> 0);
var add3H = (t, e, n, r) => e + n + r + (t / 2 ** 32 | 0) | 0;
var add4L = (t, e, n, r) => (t >>> 0) + (e >>> 0) + (n >>> 0) + (r >>> 0);
var add4H = (t, e, n, r, s) => e + n + r + s + (t / 2 ** 32 | 0) | 0;
var add5L = (t, e, n, r, s) => (t >>> 0) + (e >>> 0) + (n >>> 0) + (r >>> 0) + (s >>> 0);
var add5H = (t, e, n, r, s, o) => e + n + r + s + o + (t / 2 ** 32 | 0) | 0;
var u64 = {
  fromBig,
  split,
  toBig,
...
var SHA512 = class extends SHA2$1 {
  constructor() {
    super(128, 64, 16, false), this.Ah = 1779033703, this.Al = -205731576, this.Bh = -1150833019, this.Bl = -2067093701, this.Ch = 1013904242, this.Cl = -23791573, this.Dh = -1521486534, this.Dl = 1595750129, this.Eh = 1359893119, this.El = -1377402159, this.Fh = -1694144372, this.Fl = 725511199, this.Gh = 528734635, this.Gl = -79577749, this.Hh = 1541459225, this.Hl = 327033209;
  }
  // prettier-ignore
  ...
  process(e, n) {
    for (let C2 = 0; C2 < 16; C2++, n += 4)
      SHA512_W_H[C2] = e.getUint32(n), SHA512_W_L[C2] = e.getUint32(n += 4);
    for (let C2 = 16; C2 < 80; C2++) {
      const W = SHA512_W_H[C2 - 15] | 0, q = SHA512_W_L[C2 - 15] | 0, I = u64.rotrSH(W, q, 1) ^ u64.rotrSH(W, q, 8) ^ u64.shrSH(W, q, 7), L = u64.rotrSL(W, q, 1) ^ u64.rotrSL(W, q, 8) ^ u64.shrSL(W, q, 7), P = SHA512_W_H[C2 - 2] | 0, ie = SHA512_W_L[C2 - 2] | 0, te = u64.rotrSH(P, ie, 19) ^ u64.rotrBH(P, ie, 61) ^ u64.shrSH(P, ie, 6), T = u64.rotrSL(P, ie, 19) ^ u64.rotrBL(P, ie, 61) ^ u64.shrSL(P, ie, 6), O = u64.add4L(L, T, SHA512_W_L[C2 - 7], SHA512_W_L[C2 - 16]), K = u64.add4H(O, I, te, SHA512_W_H[C2 - 7], SHA512_W_H[C2 - 16]);
      SHA512_W_H[C2] = K | 0, SHA512_W_L[C2] = O | 0;
    }
    let { Ah: r, Al: s, Bh: o, Bl: a, Ch: c, Cl: h, Dh: p, Dl: g, Eh: y, El: $, Fh: k, Fl: S, Gh: w, Gl: x, Hh: A, Hl: N } = this;
    for (let C2 = 0; C2 < 80; C2++) {
      const W = u64.rotrSH(y, $, 14) ^ u64.rotrSH(y, $, 18) ^ u64.rotrBH(y, $, 41), q = u64.rotrSL(y, $, 14) ^ u64.rotrSL(y, $, 18) ^ u64.rotrBL(y, $, 41), I = y & k ^ ~y & w, L = $ & S ^ ~$ & x, P = u64.add5L(N, q, L, SHA512_Kl[C2], SHA512_W_L[C2]), ie = u64.add5H(P, A, W, I, SHA512_Kh[C2], SHA512_W_H[C2]), te = P | 0, T = u64.rotrSH(r, s, 28) ^ u64.rotrBH(r, s, 34) ^ u64.rotrBH(r, s, 39), O = u64.rotrSL(r, s, 28) ^ u64.rotrBL(r, s, 34) ^ u64.rotrBL(r, s, 39), K = r & o ^ r & c ^ o & c, ae = s & a ^ s & h ^ a & h;
      A = w | 0, N = x | 0, w = k | 0, x = S | 0, k = y | 0, S = $ | 0, { h: y, l: $ } = u64.add(p | 0, g | 0, ie | 0, te | 0), p = c | 0, g = h | 0, c = o | 0, h = a | 0, o = r | 0, a = s | 0;
      const E2 = u64.add3L(te, O, ae);
      r = u64.add3H(E2, ie, T, K), s = E2 | 0;
    }
...
var sha512 = wrapConstructor$1(() => new SHA512());
function number$1(t) {
  if (!Number.isSafeInteger(t) || t < 0)
    throw new Error(`Wrong positive integer: ${t}`);
}
...
var u8a$2 = (t) => t instanceof Uint8Array;
var createView = (t) => new DataView(t.buffer, t.byteOffset, t.byteLength);
var rotr = (t, e) => t << 32 - e | t >>> e;
...
var SHA2 = class extends Hash {
  constructor(e, n, r, s) {
    super(), this.blockLen = e, this.outputLen = n, this.padOffset = r, this.isLE = s, this.finished = false, this.length = 0, this.pos = 0, this.destroyed = false, this.buffer = new Uint8Array(e), this.view = createView(this.buffer);
  }
  update(e) {
  ...
  digestInto(e) {
    assert$1.exists(this), assert$1.output(e, this), this.finished = true;
    const { buffer: n, view: r, blockLen: s, isLE: o } = this;
    let { pos: a } = this;
    n[a++] = 128, this.buffer.subarray(a).fill(0), this.padOffset > s - a && (this.process(r, 0), a = 0);
    for (let y = a; y < s; y++)
...
var Chi$1 = (t, e, n) => t & e ^ ~t & n;
var Maj$1 = (t, e, n) => t & e ^ t & n ^ e & n;
...
var SHA256$1 = class extends SHA2 {
  constructor() {
    super(64, 32, 8, false), this.A = IV[0] | 0, this.B = IV[1] | 0, this.C = IV[2] | 0, this.D = IV[3] | 0, this.E = IV[4] | 0, this.F = IV[5] | 0, this.G = IV[6] | 0, this.H = IV[7] | 0;
  }
  get() {
    const { A: e, B: n, C: r, D: s, E: o, F: a, G: c, H: h } = this;
    return [e, n, r, s, o, a, c, h];
  ...
  process(e, n) {
    for (let y = 0; y < 16; y++, n += 4)
      SHA256_W$1[y] = e.getUint32(n, false);
    for (let y = 16; y < 64; y++) {
...
var SHA224 = class extends SHA256$1 {
  constructor() {
    super(), this.A = -1056596264, this.B = 914150663, this.C = 812702999, this.D = -150054599, this.E = -4191439, this.F = 1750603025, this.G = 1694076839, this.H = -1090891868, this.outputLen = 28;
  }
};
var sha256$1 = wrapConstructor(() => new SHA256$1());
wrapConstructor(() => new SHA224());
var _0n$8 = BigInt(0);
var _1n$9 = BigInt(1);
var _2n$5 = BigInt(2);
var u8a$1 = (t) => t instanceof Uint8Array;
var hexes$1 = Array.from({ length: 256 }, (t, e) => e.toString(16).padStart(2, "0"));
...
var bitSet$1 = (t, e, n) => t | (n ? _1n$9 : _0n$8) << BigInt(e);
var bitMask$1 = (t) => (_2n$5 << BigInt(t - 1)) - _1n$9;
var u8n$1 = (t) => new Uint8Array(t);
var u8fr$1 = (t) => Uint8Array.from(t);
...
var ut$1 = Object.freeze(Object.defineProperty({
  __proto__: null,
  bitGet: bitGet$1,
  bitLen: bitLen$1,
  bitMask: bitMask$1,
...
function Field$1(t, e, n = false, r = {}) {
  if (t <= _0n$7)
    throw new Error(`Expected Fp ORDER > 0, got ${t}`);
...
function hashToPrivateScalar(t, e, n = false) {
...
function weierstrassPoints$1(t) {
  ...
  function h(S) {
    ...
    let C2;
    try {
      C2 = typeof S == "bigint" ? S : bytesToNumberBE$1(ensureBytes$2("private key", S, x));
    } catch {
      throw new Error(`private key must be ${x} bytes, hex or bigint, not ${typeof S}`);
    }
    return A && (C2 = mod$1(C2, N)), c(C2), C2;
  }
  const p = /* @__PURE__ */ new Map();
  function g(S) {
    if (!(S instanceof y))
  ...
  class y {
    ...
    // Cost: 8M + 3S + 3*a + 2*b3 + 15add.
    double() {
      const { a: w, b: x } = e, A = n.mul(x, _3n$2), { px: N, py: C2, pz: W } = this;
      let q = n.ZERO, I = n.ZERO, L = n.ZERO, P = n.mul(N, N), ie = n.mul(C2, C2), te = n.mul(W, W), T = n.mul(N, C2);
      return T = n.add(T, T), L = n.mul(N, W), L = n.add(L, L), q = n.mul(w, L), I = n.mul(A, te), I = n.add(q, I), q = n.sub(ie, I), I = n.add(ie, I), I = n.mul(q, I), q = n.mul(T, q), L = n.mul(A, L), te = n.mul(w, te), T = n.sub(P, te), T = n.mul(w, T), T = n.add(T, L), L = n.add(P, P), P = n.add(L, P), P = n.add(P, te), P = n.mul(P, T), I = n.add(I, P), te = n.mul(C2, W), te = n.add(te, te), P = n.mul(te, T), q = n.sub(q, P), L = n.mul(te, ie), L = n.add(L, L), L = n.add(L, L), new y(q, I, L);
    }
    // Renes-Costello-Batina exception-free addition formula.
    ...
    multiplyUnsafe(w) {
      ...
      if (!A)
        return k.unsafeLadder(this, w);
      let { k1neg: N, k1: C2, k2neg: W, k2: q } = A.splitScalar(w), I = x, L = x, P = this;
      for (; C2 > _0n$5 || q > _0n$5; )
        C2 & _1n$6 && (I = I.add(P)), q & _1n$6 && (L = L.add(P)), P = P.double(), C2 >>= _1n$6, q >>= _1n$6;
      return N && (I = I.negate()), W && (L = L.negate()), L = new y(n.mul(L.px, A.beta), L.py, L.pz), I.add(L);
    }
    /**
     * Constant time multiplication.
     ...
     */
    multiplyAndAddUnsafe(w, x, A) {
      const N = y.BASE, C2 = (q, I) => I === _0n$5 || I === _1n$6 || !q.equals(N) ? q.multiplyUnsafe(I) : q.multiply(I), W = C2(this, x).add(C2(w, A));
      return W.is0() ? void 0 : W;
    }
    // Converts Projective point to affine (x, y) coordinates.
    // Can accept precomputed Z^-1 - for example, from invertBatch.
...
function weierstrass$1(t) {
  ...
  function a(E2) {
    return _0n$5 < E2 && E2 < n.ORDER;
  }
  function c(E2) {
    return mod$1(E2, r);
  }
  function h(E2) {
    return invert$1(E2, r);
  }
  ...
  }), k = (E2) => bytesToHex$1(numberToBytesBE$1(E2, e.nByteLength));
  function S(E2) {
    const B = r >> _1n$6;
    return E2 > B;
  }
  ...
  const x = (E2, B, H) => bytesToNumberBE$1(E2.slice(B, H));
  class A {
    constructor(B, H, Q) {
      this.r = B, this.s = H, this.recovery = Q, this.assertValidity();
    }
  ...
  const N = {
     ...
     */
    randomPrivateKey: () => {
      const E2 = e.randomBytes(n.BYTES + 8), B = hashToPrivateScalar(E2, r);
  ...
  const I = e.bits2int || function(E2) {
    const B = bytesToNumberBE$1(E2), H = E2.length * 8 - e.nBitLength;
    return H > 0 ? B >> BigInt(H) : B;
  }, L = e.bits2int_modN || function(E2) {
    return c(I(E2));
  ...
  function ie(E2) {
    ...
    if (!(_0n$5 <= E2 && E2 < P))
      throw new Error(`bigint expected < 2^${e.nBitLength}`);
    return numberToBytesBE$1(E2, e.nByteLength);
  }
  function te(E2, B, H = T) {
    if (["recovered", "canonical"].some((de) => de in H))
      throw new Error("sign() legacy options not supported");
    const { hash: Q, randomBytes: F } = e;
    let { lowS: ce, prehash: oe, extraEntropy: le } = H;
    ce == null && (ce = true), E2 = ensureBytes$2("msgHash", E2), oe && (E2 = ensureBytes$2("prehashed msgHash", Q(E2)));
    const ve = L(E2), xe = g(B), Se = [ie(xe), ie(ve)];
    if (le != null) {
      const de = le === true ? F(n.BYTES) : le;
...
var HMAC$1 = class extends Hash {
  constructor(e, n) {
    super(), this.finished = false, this.destroyed = false, assert$1.hash(e);
    const r = toBytes$1(n);
    if (this.iHash = e.create(), typeof this.iHash.update != "function")
      throw new Error("Expected instance of class which extends utils.Hash");
    this.blockLen = this.iHash.blockLen, this.outputLen = this.iHash.outputLen;
  ...
  digestInto(e) {
    assert$1.exists(this), assert$1.bytes(e, this.outputLen), this.finished = true, this.iHash.digestInto(e), this.oHash.update(e), this.oHash.digestInto(e), this.destroy();
  }
  digest() {
    const e = new Uint8Array(this.oHash.outputLen);
    return this.digestInto(e), e;
...
var hmac$1 = (t, e, n) => new HMAC$1(t, e).update(n).digest();
...
var Point$1 = secp256k1$1.ProjectivePoint;
var base58check = base58check$1(sha256$2);
...
var MASTER_SECRET = utf8ToBytes$4("Bitcoin seed");
var BITCOIN_VERSIONS = { private: 76066276, public: 76067358 };
var HARDENED_OFFSET = 2147483648;
var hash160 = (t) => ripemd160(sha256$2(t));
var fromU32 = (t) => createView$1(t).getUint32(0, false);
var toU32 = (t) => {
  if (!Number.isSafeInteger(t) || t < 0 || t > 2 ** 32 - 1)
    throw new Error(`Invalid number=${t}. Should be from 0 to 2 ** 32 - 1`);
  const e = new Uint8Array(4);
  return createView$1(e).setUint32(0, t, false), e;
};
var HDKey = class _HDKey {
  ...
  static fromExtendedKey(e, n = BITCOIN_VERSIONS) {
    const r = base58check.decode(e), s = createView$1(r), o = s.getUint32(0, false), a = {
      versions: n,
      depth: r[4],
      parentFingerprint: s.getUint32(5, false),
      index: s.getUint32(9, false),
      chainCode: r.slice(13, 45)
    }, c = r.slice(45), h = c[0] === 0;
    if (o !== n[h ? "private" : "public"])
      throw new Error("Version mismatch");
    return h ? new _HDKey({ ...a, privateKey: c.slice(1) }) : new _HDKey({ ...a, publicKey: c });
  }
  static fromJSON(e) {
    return _HDKey.fromExtendedKey(e.xpriv);
  }
  constructor(e) {
    ...
    if (e.privateKey) {
      ...
      this.privKey = typeof e.privateKey == "bigint" ? e.privateKey : bytesToNumber(e.privateKey), this.privKeyBytes = numberToBytes(this.privKey), this.pubKey = secp256k1$1.getPublicKey(e.privateKey, true);
    } else if (e.publicKey)
      this.pubKey = Point$1.fromHex(e.publicKey).toRawBytes(true);
    else
...
var u8a = (t) => t instanceof Uint8Array;
var u32 = (t) => new Uint32Array(t.buffer, t.byteOffset, Math.floor(t.byteLength / 4));
...
var isPlainObject = (t) => Object.prototype.toString.call(t) === "[object Object]" && t.constructor === Object;
...
var u8to16 = (t, e) => t[e++] & 255 | (t[e++] & 255) << 8;
var Poly1305 = class {
  constructor(e) {
    this.blockLen = 16, this.outputLen = 16, this.buffer = new Uint8Array(16), this.r = new Uint16Array(10), this.h = new Uint16Array(10), this.pad = new Uint16Array(8), this.pos = 0, this.finished = false, e = toBytes(e), ensureBytes$1(e, 32);
  ...
  process(e, n, r = false) {
    const s = r ? 0 : 2048, { h: o, r: a } = this, c = a[0], h = a[1], p = a[2], g = a[3], y = a[4], $ = a[5], k = a[6], S = a[7], w = a[8], x = a[9], A = u8to16(e, n + 0), N = u8to16(e, n + 2), C2 = u8to16(e, n + 4), W = u8to16(e, n + 6), q = u8to16(e, n + 8), I = u8to16(e, n + 10), L = u8to16(e, n + 12), P = u8to16(e, n + 14);
    let ie = o[0] + (A & 8191), te = o[1] + ((A >>> 13 | N << 3) & 8191), T = o[2] + ((N >>> 10 | C2 << 6) & 8191), O = o[3] + ((C2 >>> 7 | W << 9) & 8191), K = o[4] + ((W >>> 4 | q << 12) & 8191), ae = o[5] + (q >>> 1 & 8191), E2 = o[6] + ((q >>> 14 | I << 2) & 8191), B = o[7] + ((I >>> 11 | L << 5) & 8191), H = o[8] + ((L >>> 8 | P << 8) & 8191), Q = o[9] + (P >>> 5 | s), F = 0, ce = F + ie * c + te * (5 * x) + T * (5 * w) + O * (5 * S) + K * (5 * k);
    F = ce >>> 13, ce &= 8191, ce += ae * (5 * $) + E2 * (5 * y) + B * (5 * g) + H * (5 * p) + Q * (5 * h), F += ce >>> 13, ce &= 8191;
    let oe = F + ie * h + te * c + T * (5 * x) + O * (5 * w) + K * (5 * S);
    F = oe >>> 13, oe &= 8191, oe += ae * (5 * k) + E2 * (5 * $) + B * (5 * y) + H * (5 * g) + Q * (5 * p), F += oe >>> 13, oe &= 8191;
    let le = F + ie * p + te * h + T * c + O * (5 * x) + K * (5 * w);
    F = le >>> 13, le &= 8191, le += ae * (5 * S) + E2 * (5 * k) + B * (5 * $) + H * (5 * y) + Q * (5 * g), F += le >>> 13, le &= 8191;
    let ve = F + ie * g + te * p + T * h + O * c + K * (5 * x);
    F = ve >>> 13, ve &= 8191, ve += ae * (5 * w) + E2 * (5 * S) + B * (5 * k) + H * (5 * $) + Q * (5 * y), F += ve >>> 13, ve &= 8191;
    let xe = F + ie * y + te * g + T * p + O * h + K * c;
    F = xe >>> 13, xe &= 8191, xe += ae * (5 * x) + E2 * (5 * w) + B * (5 * S) + H * (5 * k) + Q * (5 * $), F += xe >>> 13, xe &= 8191;
    let Se = F + ie * $ + te * y + T * g + O * p + K * h;
    F = Se >>> 13, Se &= 8191, Se += ae * c + E2 * (5 * x) + B * (5 * w) + H * (5 * S) + Q * (5 * k), F += Se >>> 13, Se &= 8191;
    let Te = F + ie * k + te * $ + T * y + O * g + K * p;
    F = Te >>> 13, Te &= 8191, Te += ae * h + E2 * c + B * (5 * x) + H * (5 * w) + Q * (5 * S), F += Te >>> 13, Te &= 8191;
    let Ae = F + ie * S + te * k + T * $ + O * y + K * g;
    F = Ae >>> 13, Ae &= 8191, Ae += ae * p + E2 * h + B * c + H * (5 * x) + Q * (5 * w), F += Ae >>> 13, Ae &= 8191;
    let Oe = F + ie * w + te * S + T * k + O * $ + K * y;
    F = Oe >>> 13, Oe &= 8191, Oe += ae * g + E2 * p + B * h + H * c + Q * (5 * x), F += Oe >>> 13, Oe &= 8191;
    let de = F + ie * x + te * w + T * S + O * k + K * $;
    F = de >>> 13, de &= 8191, de += ae * y + E2 * g + B * p + H * h + Q * c, F += de >>> 13, de &= 8191, F = (F << 2) + F | 0, F = F + ce | 0, ce = F & 8191, F = F >>> 13, oe += F, o[0] = ce, o[1] = oe, o[2] = le, o[3] = ve, o[4] = xe, o[5] = Se, o[6] = Te, o[7] = Ae, o[8] = Oe, o[9] = de;
  }
  finalize() {
  ...
  update(e) {
    ...
    for (let o = 0; o < s; ) {
      ...
      n.set(e.subarray(o, o + a), this.pos), this.pos += a, o += a, this.pos === r && (this.process(n, 0, false), this.pos = 0);
    }
    return this;
  }
  destroy() {
  ...
  digestInto(e) {
    assert.exists(this), assert.output(e, this), this.finished = true;
...
var sigma16 = utf8ToBytes$1("expand 16-byte k");
var sigma32 = utf8ToBytes$1("expand 32-byte k");
var sigma16_32 = u32(sigma16);
var sigma32_32 = u32(sigma32);
var isAligned32 = (t) => !(t.byteOffset % 4);
var salsaBasic = (t) => {
  const { core: e, rounds: n, counterRight: r, counterLen: s, allow128bitKeys: o, extendNonceFn: a, blockLen: c } = checkOpts({ rounds: 20, counterRight: false, counterLen: 8, allow128bitKeys: true, blockLen: 64 }, t);
  ...
  return (p, g, y, $, k = 0) => {
    ...
    const N = new Uint8Array(c), C2 = u32(N), W = u32(w), q = u32(g), I = isAligned32(y) && u32(y), L = isAligned32($) && u32($);
    S.push(C2);
    const P = y.length;
    for (let ie = 0, te = k; ie < P; te++) {
      if (e(x, W, q, C2, te, n), te >= 2 ** 32 - 1)
        throw new Error("Salsa/ChaCha: counter overflow");
...
var rotl = (t, e) => t << e | t >>> 32 - e;
function chachaCore(t, e, n, r, s, o = 20) {
  let a = t[0], c = t[1], h = t[2], p = t[3], g = e[0], y = e[1], $ = e[2], k = e[3], S = e[4], w = e[5], x = e[6], A = e[7], N = s, C2 = n[0], W = n[1], q = n[2], I = a, L = c, P = h, ie = p, te = g, T = y, O = $, K = k, ae = S, E2 = w, B = x, H = A, Q = N, F = C2, ce = W, oe = q;
  for (let ve = 0; ve < o; ve += 2)
    I = I + te | 0, Q = rotl(Q ^ I, 16), ae = ae + Q | 0, te = rotl(te ^ ae, 12), I = I + te | 0, Q = rotl(Q ^ I, 8), ae = ae + Q | 0, te = rotl(te ^ ae, 7), L = L + T | 0, F = rotl(F ^ L, 16), E2 = E2 + F | 0, T = rotl(T ^ E2, 12), L = L + T | 0, F = rotl(F ^ L, 8), E2 = E2 + F | 0, T = rotl(T ^ E2, 7), P = P + O | 0, ce = rotl(ce ^ P, 16), B = B + ce | 0, O = rotl(O ^ B, 12), P = P + O | 0, ce = rotl(ce ^ P, 8), B = B + ce | 0, O = rotl(O ^ B, 7), ie = ie + K | 0, oe = rotl(oe ^ ie, 16), H = H + oe | 0, K = rotl(K ^ H, 12), ie = ie + K | 0, oe = rotl(oe ^ ie, 8), H = H + oe | 0, K = rotl(K ^ H, 7), I = I + T | 0, oe = rotl(oe ^ I, 16), B = B + oe | 0, T = rotl(T ^ B, 12), I = I + T | 0, oe = rotl(oe ^ I, 8), B = B + oe | 0, T = rotl(T ^ B, 7), L = L + O | 0, Q = rotl(Q ^ L, 16), H = H + Q | 0, O = rotl(O ^ H, 12), L = L + O | 0, Q = rotl(Q ^ L, 8), H = H + Q | 0, O = rotl(O ^ H, 7), P = P + K | 0, F = rotl(F ^ P, 16), ae = ae + F | 0, K = rotl(K ^ ae, 12), P = P + K | 0, F = rotl(F ^ P, 8), ae = ae + F | 0, K = rotl(K ^ ae, 7), ie = ie + te | 0, ce = rotl(ce ^ ie, 16), E2 = E2 + ce | 0, te = rotl(te ^ E2, 12), ie = ie + te | 0, ce = rotl(ce ^ ie, 8), E2 = E2 + ce | 0, te = rotl(te ^ E2, 7);
  let le = 0;
  r[le++] = a + I | 0, r[le++] = c + L | 0, r[le++] = h + P | 0, r[le++] = p + ie | 0, r[le++] = g + te | 0, r[le++] = y + T | 0, r[le++] = $ + O | 0, r[le++] = k + K | 0, r[le++] = S + ae | 0, r[le++] = w + E2 | 0, r[le++] = x + B | 0, r[le++] = A + H | 0, r[le++] = N + Q | 0, r[le++] = C2 + F | 0, r[le++] = W + ce | 0, r[le++] = q + oe | 0;
}
...
var hkdf = (t, e, n, r, s) => expand(t, extract(t, e, n), r, s);
var __defProp = Object.defineProperty;
var __export = (t, e) => {
  for (var n in e)
    __defProp(t, n, { get: e[n], enumerable: true });
};
...
function finishEvent(t, e) {
  const n = t;
  return n.pubkey = getPublicKey(e), n.id = getEventHash$1(n), n.sig = getSignature(n, e), n[verifiedSymbol] = true, n;
}
...
function relayInit(t, e = {}) {
  ...
  async function y() {
    return g || (g = new Promise((A, N) => {
      ...
      let C2 = new MessageQueue(), W;
      o.onmessage = (I) => {
        C2.enqueue(I.data), W || (W = setInterval(q, 0));
      };
      function q() {
        var P, ie, te;
        if (C2.size === 0) {
        ...
        try {
          ...
          switch (T[0]) {
            case "EVENT": {
              let E2 = T[1], B = T[2];
              validateEvent(B) && a[E2] && (a[E2].skipVerification || verifySignature$1(B)) && matchFilters(a[E2].filters, B) && (a[E2], (((P = h[E2]) == null ? void 0 : P.event) || []).forEach((H) => H(B)));
              return;
            }
            case "COUNT":
              let O = T[1], K = T[2];
              a[O] && (((ie = h[O]) == null ? void 0 : ie.count) || []).forEach((E2) => E2(K));
              return;
            case "EOSE": {
              let E2 = T[1];
              E2 in h && (h[E2].eose.forEach((B) => B()), h[E2].eose = []);
              return;
            }
            case "OK": {
              let E2 = T[1], B = T[2], H = T[3] || "";
              if (E2 in p) {
                let { resolve: Q, reject: F } = p[E2];
            ...
            case "NOTICE":
              let ae = T[1];
              c.notice.forEach((E2) => E2(ae));
              return;
            case "AUTH": {
              let E2 = T[1];
              (te = c.auth) == null || te.forEach((B) => B(E2));
              return;
            }
          }
        } catch {
  ...
  async function S(A) {
    ...
    if (!(!$() && (await new Promise((C2) => setTimeout(C2, 1e3)), !$())))
      try {
        o.send(N);
      } catch (C2) {
        console.log(C2);
  ...
  const w = (A, {
    ...
    let L = {
      sub: (P, ie = {}) => w(P || A, {
        skipVerification: ie.skipVerification || C2,
  ...
  return {
    ...
    off: (A, N) => {
      let C2 = c[A].indexOf(N);
      C2 !== -1 && c[A].splice(C2, 1);
    },
    list: (A, N) => new Promise((C2) => {
      let W = w(A, N), q = [], I = setTimeout(() => {
        W.unsub(), C2(q);
      }, n);
      W.on("eose", () => {
        W.unsub(), clearTimeout(I), C2(q);
      }), W.on("event", (L) => {
        q.push(L);
      });
    }),
    get: (A, N) => new Promise((C2) => {
      let W = w([A], N), q = setTimeout(() => {
        W.unsub(), C2(null);
      }, r);
      W.on("event", (I) => {
        W.unsub(), clearTimeout(q), C2(I);
      });
    }),
    count: (A) => new Promise((N) => {
      let C2 = w(A, { ...w, verb: "COUNT" }), W = setTimeout(() => {
        C2.unsub(), N(null);
      }, s);
      C2.on("count", (q) => {
        C2.unsub(), clearTimeout(W), N(q);
      });
    }),
    async publish(A) {
      await x(A, "EVENT");
...
async function encrypt$1(t, e, n) {
  ...
  let o = Uint8Array.from(randomBytes$2(16)), a = utf8Encoder.encode(n), c = await crypto.subtle.importKey("raw", s, { name: "AES-CBC" }, false, ["encrypt"]), h = await crypto.subtle.encrypt({ name: "AES-CBC", iv: o }, c, a), p = base64.encode(new Uint8Array(h)), g = base64.encode(new Uint8Array(o.buffer));
  return `${p}?iv=${g}`;
}
async function decrypt$1(t, e, n) {
  let [r, s] = n.split("?iv="), o = secp256k1$2.getSharedSecret(t, "02" + e), a = getNormalizedX(o), c = await crypto.subtle.importKey("raw", a, { name: "AES-CBC" }, false, ["decrypt"]), h = base64.decode(r), p = base64.decode(s), g = await crypto.subtle.decrypt({ name: "AES-CBC", iv: p }, c, h);
...
var channelHideMessageEvent = (t, e) => {
  let n;
  if (typeof t.content == "object")
    n = JSON.stringify(t.content);
  else if (typeof t.content == "string")
...
async function getToken(t, e, n, r = false) {
  if (!t || !e)
...
var bakeCollection2 = {};
(function(exports) {
  Object.defineProperty(exports, "__esModule", { value: true }), exports.bakeCollectionVariadic = exports.bakeCollectionAwait = exports.bakeCollection = exports.BAKED_EMPTY_FUNC = void 0, exports.BAKED_EMPTY_FUNC = function() {
  };
...
var bake_collection_1 = bakeCollection2;
...
function insert_norebuild(t) {
  for (var e, n = [], r = 1; r < arguments.length; r++)
    n[r - 1] = arguments[r];
  this.length === 0 ? (this._tasks = n, this.length = 1) : this.length === 1 ? (n.unshift(this._tasks), this._tasks = n, this.length = this._tasks.length) : ((e = this._tasks).splice.apply(e, __spreadArray$1([t, 0], n, false)), this.length = this._tasks.length);
}
function insert_rebuild(t) {
  for (var e, n = [], r = 1; r < arguments.length; r++)
    n[r - 1] = arguments[r];
  this.length === 0 ? (this._tasks = n, this.length = 1) : this.length === 1 ? (n.unshift(this._tasks), this._tasks = n, this.length = this._tasks.length) : ((e = this._tasks).splice.apply(e, __spreadArray$1([t, 0], n, false)), this.length = this._tasks.length), this.firstEmitBuildStrategy ? this.call = rebuild_on_first_call : this.rebuild();
}
...
var TaskCollection = (
  ...
  /* @__PURE__ */ function() {
    function t(e, n, r, s) {
      n === void 0 && (n = true), r === void 0 && (r = null), s === void 0 && (s = false), this.awaitTasks = s, this.call = bake_collection_1.BAKED_EMPTY_FUNC, this.argsNum = e, this.firstEmitBuildStrategy = true, s ? this.rebuild = rebuild_await.bind(this) : this.rebuild = rebuild_noawait.bind(this), this.setAutoRebuild(n), r ? typeof r == "function" ? (this._tasks = r, this.length = 1) : (this._tasks = r, this.length = r.length) : (this._tasks = null, this.length = 0), n && this.rebuild();
    }
    return t;
  }()
);
...
(function(t) {
  ...
  Object.defineProperty(t, "__esModule", { value: true }), n(taskCollection, t);
})(taskCollection$1);
var utils = {};
...
function emit(t, e, n, r, s, o) {
  var a = this.events[t];
  return a ? a.length === 0 ? false : (a.argsNum < 6 ? a.call(e, n, r, s, o) : a.call.apply(void 0, arguments), true) : false;
}
...
function addListener(t, e, n) {
  ...
  var r = this.events[t];
  return r ? (r.push(e), r.growArgsNum(n), this.maxListeners !== 1 / 0 && this.maxListeners <= r.length && console.warn('Maximum event listeners for "'.concat(String(t), '" event!'))) : (this.events[t] = new task_collection_1.TaskCollection(n, true, e, false), typeof t == "symbol" && this._symbolKeys.add(t)), this;
}
...
function prependListener(t, e, n) {
  if (n === void 0 && (n = e.length), typeof e != "function")
    throw new TypeError("The listener must be a function");
  var r = this.events[t];
  return !r || !(r instanceof task_collection_1.TaskCollection) ? (r = this.events[t] = new task_collection_1.TaskCollection(n, true, e, false), typeof t == "symbol" && this._symbolKeys.add(t)) : (r.insert(0, e), r.growArgsNum(n), this.maxListeners !== 1 / 0 && this.maxListeners <= r.length && console.warn('Maximum event listeners for "'.concat(String(t), '" event!'))), this;
}
...
function listeners(t) {
  return this.emit === emit ? this.events[t] ? this.events[t].tasksAsArray().slice() : [] : this.events[t] && this.onceEvents[t] ? __spreadArray(__spreadArray([], this.events[t].tasksAsArray(), true), typeof this.onceEvents[t] == "function" ? [this.onceEvents[t]] : this.onceEvents[t], true) : this.events[t] ? this.events[t].tasksAsArray() : this.onceEvents[t] ? typeof this.onceEvents[t] == "function" ? [this.onceEvents[t]] : this.onceEvents[t] : [];
}
function eventNames() {
  var t = this;
  if (this.emit === emit) {
    var e = Object.keys(this.events);
    return __spreadArray(__spreadArray([], e, true), Array.from(this._symbolKeys), true).filter(function(r) {
    ...
    return __spreadArray(__spreadArray(__spreadArray([], e, true), n, true), Array.from(this._symbolKeys).filter(function(s) {
...
(function(t) {
  ...
  Object.defineProperty(t, "__esModule", { value: true }), n(types, t), n(ee, t);
})(lib$1);
var browser = { exports: {} };
var ms;
var hasRequiredMs;
...
function setup(t) {
  ...
  function n(g) {
    ...
    function w(...x) {
      if (!w.enabled)
        return;
      const A = w, N = Number(/* @__PURE__ */ new Date()), C2 = N - (y || N);
      A.diff = C2, A.prev = y, A.curr = N, y = N, x[0] = n.coerce(x[0]), typeof x[0] != "string" && x.unshift("%O");
      let W = 0;
...
(function(t, e) {
  e.formatArgs = r, e.save = s, e.load = o, e.useColors = n, e.storage = a(), e.destroy = /* @__PURE__ */ (() => {
    let h = false;
    return () => {
      h || (h = true, console.warn("Instance method `debug.destroy()` is deprecated and no longer does anything. It will be removed in the next major version of `debug`."));
    };
  })(), e.colors = [
    "#0000CC",
    "#0000FF",
...
var Chi = (t, e, n) => t & e ^ ~t & n;
var Maj = (t, e, n) => t & e ^ t & n ^ e & n;
var HashMD = class extends Hash$6 {
  constructor(e, n, r, s) {
    super(), this.blockLen = e, this.outputLen = n, this.padOffset = r, this.isLE = s, this.finished = false, this.length = 0, this.pos = 0, this.destroyed = false, this.buffer = new Uint8Array(e), this.view = createView$6(this.buffer);
  }
  update(e) {
    exists$7(this);
    const { view: n, buffer: r, blockLen: s } = this;
  ...
  digestInto(e) {
    exists$7(this), output$7(e, this), this.finished = true;
    const { buffer: n, view: r, blockLen: s, isLE: o } = this;
    let { pos: a } = this;
    n[a++] = 128, this.buffer.subarray(a).fill(0), this.padOffset > s - a && (this.process(r, 0), a = 0);
    for (let y = a; y < s; y++)
...
var SHA256 = class extends HashMD {
  constructor() {
    super(64, 32, 8, false), this.A = SHA256_IV[0] | 0, this.B = SHA256_IV[1] | 0, this.C = SHA256_IV[2] | 0, this.D = SHA256_IV[3] | 0, this.E = SHA256_IV[4] | 0, this.F = SHA256_IV[5] | 0, this.G = SHA256_IV[6] | 0, this.H = SHA256_IV[7] | 0;
  }
  get() {
    const { A: e, B: n, C: r, D: s, E: o, F: a, G: c, H: h } = this;
    return [e, n, r, s, o, a, c, h];
  ...
  process(e, n) {
    for (let y = 0; y < 16; y++, n += 4)
      SHA256_W[y] = e.getUint32(n, false);
    for (let y = 16; y < 64; y++) {
...
var sha256 = wrapConstructor$6(() => new SHA256());
var _0n$4 = BigInt(0);
var _1n$4 = BigInt(1);
var _2n$2 = BigInt(2);
function isBytes(t) {
...
var hexes = Array.from({ length: 256 }, (t, e) => e.toString(16).padStart(2, "0"));
...
var bitMask = (t) => (_2n$2 << BigInt(t - 1)) - _1n$4;
var u8n = (t) => new Uint8Array(t);
var u8fr = (t) => Uint8Array.from(t);
...
function mapHashToField(t, e, n = false) {
...
function weierstrassPoints(t) {
  ...
  function h(S) {
    ...
    let C2;
    try {
      C2 = typeof S == "bigint" ? S : bytesToNumberBE(ensureBytes("private key", S, x));
    } catch {
      throw new Error(`private key must be ${x} bytes, hex or bigint, not ${typeof S}`);
    }
    return A && (C2 = mod(C2, N)), c(C2), C2;
  }
  const p = /* @__PURE__ */ new Map();
  function g(S) {
    if (!(S instanceof y))
  ...
  class y {
    ...
    // Cost: 8M + 3S + 3*a + 2*b3 + 15add.
    double() {
      const { a: w, b: x } = e, A = n.mul(x, _3n), { px: N, py: C2, pz: W } = this;
      let q = n.ZERO, I = n.ZERO, L = n.ZERO, P = n.mul(N, N), ie = n.mul(C2, C2), te = n.mul(W, W), T = n.mul(N, C2);
      return T = n.add(T, T), L = n.mul(N, W), L = n.add(L, L), q = n.mul(w, L), I = n.mul(A, te), I = n.add(q, I), q = n.sub(ie, I), I = n.add(ie, I), I = n.mul(q, I), q = n.mul(T, q), L = n.mul(A, L), te = n.mul(w, te), T = n.sub(P, te), T = n.mul(w, T), T = n.add(T, L), L = n.add(P, P), P = n.add(L, P), P = n.add(P, te), P = n.mul(P, T), I = n.add(I, P), te = n.mul(C2, W), te = n.add(te, te), P = n.mul(te, T), q = n.sub(q, P), L = n.mul(te, ie), L = n.add(L, L), L = n.add(L, L), new y(q, I, L);
    }
    // Renes-Costello-Batina exception-free addition formula.
    ...
    multiplyUnsafe(w) {
      ...
      if (!A)
        return k.unsafeLadder(this, w);
      let { k1neg: N, k1: C2, k2neg: W, k2: q } = A.splitScalar(w), I = x, L = x, P = this;
      for (; C2 > _0n$1 || q > _0n$1; )
        C2 & _1n$1 && (I = I.add(P)), q & _1n$1 && (L = L.add(P)), P = P.double(), C2 >>= _1n$1, q >>= _1n$1;
      return N && (I = I.negate()), W && (L = L.negate()), L = new y(n.mul(L.px, A.beta), L.py, L.pz), I.add(L);
    }
    /**
     * Constant time multiplication.
     ...
     */
    multiplyAndAddUnsafe(w, x, A) {
      const N = y.BASE, C2 = (q, I) => I === _0n$1 || I === _1n$1 || !q.equals(N) ? q.multiplyUnsafe(I) : q.multiply(I), W = C2(this, x).add(C2(w, A));
      return W.is0() ? void 0 : W;
    }
    // Converts Projective point to affine (x, y) coordinates.
    // Can accept precomputed Z^-1 - for example, from invertBatch.
...
function weierstrass(t) {
  ...
  }), k = (E2) => bytesToHex(numberToBytesBE(E2, e.nByteLength));
  function S(E2) {
    const B = r >> _1n$1;
    return E2 > B;
  }
  ...
  const x = (E2, B, H) => bytesToNumberBE(E2.slice(B, H));
  class A {
    constructor(B, H, Q) {
      this.r = B, this.s = H, this.recovery = Q, this.assertValidity();
    }
  ...
  const N = {
     ...
     */
    randomPrivateKey: () => {
      const E2 = getMinHashLength(e.n);
      return mapHashToField(e.randomBytes(E2), e.n);
    },
    /**
     * Creates precompute table for an arbitrary EC point. Makes point "cached".
     * Allows to massively speed-up `point.multiply(scalar)`.
  ...
  function W(E2) {
    const B = isBytes(E2), H = typeof E2 == "string", Q = (B || H) && E2.length;
    return B ? Q === s || Q === o : H ? Q === 2 * s || Q === 2 * o : E2 instanceof p;
  }
  function q(E2, B, H = true) {
    if (W(E2))
  ...
  const I = e.bits2int || function(E2) {
    const B = bytesToNumberBE(E2), H = E2.length * 8 - e.nBitLength;
    return H > 0 ? B >> BigInt(H) : B;
  }, L = e.bits2int_modN || function(E2) {
    return c(I(E2));
  ...
  function ie(E2) {
    ...
    if (!(_0n$1 <= E2 && E2 < P))
      throw new Error(`bigint expected < 2^${e.nBitLength}`);
    return numberToBytesBE(E2, e.nByteLength);
  }
  function te(E2, B, H = T) {
    if (["recovered", "canonical"].some((de) => de in H))
      throw new Error("sign() legacy options not supported");
    const { hash: Q, randomBytes: F } = e;
    let { lowS: ce, prehash: oe, extraEntropy: le } = H;
    ce == null && (ce = true), E2 = ensureBytes("msgHash", E2), oe && (E2 = ensureBytes("prehashed msgHash", Q(E2)));
    const ve = L(E2), xe = g(B), Se = [ie(xe), ie(ve)];
    if (le != null && le !== false) {
      const de = le === true ? F(n.BYTES) : le;
...
var HMAC = class extends Hash$6 {
  constructor(e, n) {
    super(), this.finished = false, this.destroyed = false, hash$7(e);
    const r = toBytes$7(n);
    if (this.iHash = e.create(), typeof this.iHash.update != "function")
      throw new Error("Expected instance of class which extends utils.Hash");
    this.blockLen = this.iHash.blockLen, this.outputLen = this.iHash.outputLen;
  ...
  digestInto(e) {
    exists$7(this), bytes$8(e, this.outputLen), this.finished = true, this.iHash.digestInto(e), this.oHash.update(e), this.oHash.digestInto(e), this.destroy();
  }
  digest() {
    const e = new Uint8Array(this.oHash.outputLen);
    return this.digestInto(e), e;
...
var hmac = (t, e, n) => new HMAC(t, e).update(n).digest();
...
var _0n = BigInt(0);
var fe = (t) => typeof t == "bigint" && _0n < t && t < secp256k1P;
var ge = (t) => typeof t == "bigint" && _0n < t && t < secp256k1N;
...
var pointToBytes = (t) => t.toRawBytes(true).slice(1);
var numTo32b = (t) => numberToBytesBE(t, 32);
var modP = (t) => mod(t, secp256k1P);
var modN = (t) => mod(t, secp256k1N);
var Point = secp256k1.ProjectivePoint;
var GmulAdd = (t, e, n) => Point.BASE.multiplyAndAddUnsafe(t, e, n);
...
var LRUCacheNode = class {
  constructor(e, n, r) {
    ...
    this.clone = p ?? false, this.cloneFn = g ?? this.defaultClone, this.key = e, this.internalValue = this.clone ? this.cloneFn(n) : n, this.created = Date.now(), this.entryExpirationTimeInMS = s, this.next = o, this.prev = a, this.onEntryEvicted = c, this.onEntryMarkedAsMostRecentlyUsed = h;
  }
  get value() {
...
var LRUCacheNode_1 = LRUCacheNode$1;
var LRUCache = class {
  /**
  ...
  delete(e) {
    const n = this.lookupTable.get(e);
    return n ? this.removeNodeFromListAndLookupTable(n) : false;
  }
  /**
  ...
  has(e) {
    const n = this.lookupTable.get(e);
    return n ? n.isExpired ? (this.removeNodeFromListAndLookupTable(n), false) : true : false;
  }
  /**
...
(function(t) {
  ...
  Object.defineProperty(t, "__esModule", { value: true }), n(LRUCache$1, t);
})(dist);
var lib = {};
(function(t) {
  Object.defineProperty(t, "__esModule", { value: true }), t.bytes = t.stringToBytes = t.str = t.bytesToString = t.hex = t.utf8 = t.bech32m = t.bech32 = t.base58check = t.base58xmr = t.base58xrp = t.base58flickr = t.base58 = t.base64url = t.base64 = t.base32crockford = t.base32hex = t.base32 = t.base16 = t.utils = t.assertNumber = void 0;
  function e(T) {
    if (!Number.isSafeInteger(T))
      throw new Error(`Wrong integer: ${T}`);
  }
  t.assertNumber = e;
  function n(...T) {
    const O = (E2, B) => (H) => E2(B(H)), K = Array.from(T).reverse().reduce((E2, B) => E2 ? O(E2, B.encode) : B.encode, void 0), ae = T.reduce((E2, B) => E2 ? O(E2, B.decode) : B.decode, void 0);
  ...
  function o(T, O = "=") {
    ...
    return {
      ...
      decode(K) {
        ...
        for (let E2 of K)
          if (typeof E2 != "string")
            throw new Error(`padding.decode: non-string input=${E2}`);
        let ae = K.length;
        if (ae * T % 8)
          throw new Error("Invalid padding: string should have whole number of bytes");
  ...
  function g(T, O, K, ae) {
    ...
    if (E2 = E2 << K - B & H, !ae && B >= O)
      throw new Error("Excess padding");
    if (!ae && E2)
      throw new Error(`Non-zero padding: ${E2}`);
    return ae && B > 0 && Q.push(E2 >>> 0), Q;
  }
  function y(T) {
    return e(T), {
      encode: (O) => {
  ...
  function S(T, O) {
    ...
    return {
      encode(K) {
        if (!(K instanceof Uint8Array))
          throw new Error("checksum.encode: input should be Uint8Array");
        const ae = O(K).slice(0, T), E2 = new Uint8Array(K.length + T);
        return E2.set(K), E2.set(ae, K.length), E2;
      },
      decode(K) {
        if (!(K instanceof Uint8Array))
          throw new Error("checksum.decode: input should be Uint8Array");
        const ae = K.slice(0, -T), E2 = O(ae).slice(0, T), B = K.slice(-T);
        for (let H = 0; H < T; H++)
          if (E2[H] !== B[H])
            throw new Error("Invalid checksum");
        return ae;
  ...
  t.base58xmr = {
    ...
    decode(T) {
      ...
      for (let K = 0; K < T.length; K += 11) {
        const ae = T.slice(K, K + 11), E2 = x.indexOf(ae.length), B = t.base58.decode(ae);
        for (let H = 0; H < B.length - E2; H++)
          if (B[H] !== 0)
            throw new Error("base58xmr: wrong padding");
        O = O.concat(Array.from(B.slice(B.length - E2)));
      }
  ...
  t.base58check = A;
  const N = n(r("qpzry9x8gf2tvdw0s3jn54khce6mua7l"), s("")), C2 = [996825010, 642813549, 513874426, 1027748829, 705979059];
  function W(T) {
    const O = T >> 25;
    let K = (T & 33554431) << 5;
    for (let ae = 0; ae < C2.length; ae++)
      (O >> ae & 1) === 1 && (K ^= C2[ae]);
    return K;
  }
  function q(T, O, K = 1) {
    ...
    E2 = W(E2);
    for (let B = 0; B < ae; B++)
      E2 = W(E2) ^ T.charCodeAt(B) & 31;
    for (let B of O)
      E2 = W(E2) ^ B;
    for (let B = 0; B < 6; B++)
      E2 = W(E2);
    return E2 ^= K, N.encode(g([E2 % 2 ** 30], 30, 5, false));
  }
  function I(T) {
    const O = T === "bech32" ? 1 : 734539939, K = $(5), ae = K.decode, E2 = K.encode, B = k(ae);
    ...
    function Q(oe, le = 90) {
      ...
      if (oe.length < 8 || le !== false && oe.length > le)
    ...
    const F = k(Q);
    function ce(oe) {
      const { prefix: le, words: ve } = Q(oe, false);
      return { prefix: le, words: ve, bytes: ae(ve) };
    }
    return { encode: H, decode: Q, decodeToBytes: ce, decodeUnsafe: F, fromWords: ae, fromWordsUnsafe: B, toWords: E2 };
  }
...
var NDKRelayPublisher = class {
  ...
  async publishEvent(t, e) {
    ...
    const o = new Promise((c, h) => {
      r.then(() => {
        clearTimeout(s), this.ndkRelay.emit("published", t), c(true);
      }).catch((p) => {
...
var NDKGroupedSubscriptions = class extends lib$1.EventEmitter {
  ...
  [Symbol.iterator]() {
    ...
    return {
      next() {
        return e < n.length ? { value: n[e++], done: false } : { value: null, done: true };
      }
    };
  }
};
var NDKSubscriptionFilters = class {
  ...
  eventReceived(t) {
    ...
    e.relay = this.ndkRelay, this.subscription.eventReceived(e, this.ndkRelay, false);
  }
...
var NDKRelay = class extends lib$1.EventEmitter {
  constructor(e, n) {
    ...
    M(this, "trusted", false);
    M(this, "complaining", false);
    M(this, "debug");
  ...
  shouldValidateEvent() {
    return this.trusted ? false : this.validationRatio === void 0 ? true : this.getValidationRatio() < this.validationRatio;
  }
};
...
async function repost(t = true, e) {
  if (!e && t) {
    if (!this.ndk)
      throw new Error("No NDK instance found");
...
function serialize(t = false, e = false) {
...
async function verifySignatureAsync(t, e) {
  return new Promise((r) => {
    const s = t.serialize();
    let o = false;
    processingQueue[t.id] || (processingQueue[t.id] = { event: t, resolves: [] }, o = true), processingQueue[t.id].resolves.push(r), o && worker.postMessage({
      serialized: s,
      id: t.id,
      sig: t.sig,
      pubkey: t.pubkey
...
function verifySignature(t) {
  ...
  try {
    ...
    return console.error("Error verifying signature", this.rawEvent(), r), this.signatureVerified = false;
  }
}
...
var debug2 = debug("ndk:zap");
var DEFAULT_RELAYS$1 = [
  "wss://nos.lol",
...
var NDKZap = class Ur extends lib$1.EventEmitter {
  constructor(n) {
    var r;
    super();
    M(this, "ndk");
  ...
  async getZapSpecWithoutCache() {
    let n, r, s, o;
    if (this.zappedUser && (this.zappedUser.profile || await this.zappedUser.fetchProfile({ groupable: false }), o = this.zappedUser.profile, n = (this.zappedUser.profile || {}).lud06, r = (this.zappedUser.profile || {}).lud16), r && !r.startsWith("LNURL")) {
      const [a, c] = r.split("@");
...
var NDKEvent = class jt extends lib$1.EventEmitter {
  constructor(n, r) {
    super();
    M(this, "ndk");
    M(this, "created_at");
...
var NDKSubscription = class extends lib$1.EventEmitter {
  constructor(e, n, r, s, o) {
    ...
    M(this, "opts");
    M(this, "pool");
    M(this, "skipVerification", false);
    M(this, "skipValidation", false);
    M(this, "relayFilters");
    M(this, "relaySet");
    M(this, "ndk");
    M(this, "debug");
    ...
    M(this, "closeOnEose");
    M(this, "eoseTimeout");
    if (this.ndk = e, this.pool = (r == null ? void 0 : r.pool) || e.pool, this.opts = { ...defaultOpts, ...r || {} }, this.filters = n instanceof Array ? n : [n], this.subId = o || (r == null ? void 0 : r.subId), this.internalId = Math.random().toString(36).substring(7), this.relaySet = s, this.debug = e.debug.extend(`subscription[${(r == null ? void 0 : r.subId) ?? this.internalId}]`), this.eoseDebug = this.debug.extend("eose"), this.skipVerification = (r == null ? void 0 : r.skipVerification) || false, this.skipValidation = (r == null ? void 0 : r.skipValidation) || false, this.closeOnEose = (r == null ? void 0 : r.closeOnEose) || false, this.opts.cacheUsage === "ONLY_CACHE" && !this.opts.closeOnEose)
  ...
  isGroupable() {
    var e;
    return ((e = this.opts) == null ? void 0 : e.groupable) || false;
  }
  shouldQueryCache() {
    var e;
  ...
  startWithRelays() {
    ...
    for (const [e, n] of this.relayFilters)
      this.pool.getRelay(e, true, true, n).subscribe(this, n);
  }
  // EVENT handling
  /**
  ...
  eventReceived(e, n, r = false) {
    ...
    if (!r) {
      ...
      if (!this.skipVerification && !e.verifySignature(true) && !this.ndk.asyncSigVerification) {
...
var NDKUser = class Pr {
   ...
   */
  static async fromNip05(e, n, r = false) {
    if (!n)
      throw new Error("No NDK instance found");
    let s = {};
    r && (s.cache = "no-cache");
  ...
  async unfollow(e, n, r = 3) {
    ...
    let o = false;
    for (const c of n)
      c.pubkey !== e.pubkey && (s.add(c), o = true);
    if (!o)
      return false;
...
var NDKList = class Or extends NDKEvent {
  constructor(n, r) {
    super(n, r);
   ...
   */
  async addItem(n, r = void 0, s = false) {
    if (!this.ndk)
      throw new Error("NDK instance not set");
    if (!this.ndk.signer)
      throw new Error("NDK signer not set");
...
var testParameter = (t, e) => e.some((n) => n instanceof RegExp ? n.test(t) : n === t);
var supportedProtocols = /* @__PURE__ */ new Set([
  "https:",
  "http:",
  "file:"
]);
var hasCustomProtocol = (t) => {
  try {
...
var normalizeDataURL = (t, { stripHash: e }) => {
  var y;
  ...
  o = e ? "" : o;
  let c = false;
  a[a.length - 1] === "base64" && (a.pop(), c = true);
...
function normalizeUrl(t, e) {
  ...
  if (e.removeDirectoryIndex === true && (e.removeDirectoryIndex = [/^index\.[a-z]+$/]), Array.isArray(e.removeDirectoryIndex) && e.removeDirectoryIndex.length > 0) {
  ...
  if (!Array.isArray(e.keepQueryParameters) && e.removeQueryParameters === true && (s.search = ""), Array.isArray(e.keepQueryParameters) && e.keepQueryParameters.length > 0)
    for (const a of [...s.searchParams.keys()])
...
var NDKRelayList = class mn extends NDKEvent {
  constructor(e, n) {
    ...
    await Promise.all([
      ...
      new Promise(async (g) => {
        const y = await n.fetchEvents(
          ...
          { closeOnEose: true, pool: r, groupable: false },
          c
        );
        for (const $ of y)
  ...
  async blockUntilReady(n) {
    const r = await this.signer.user(), s = new Promise((c, h) => {
      ...
      h.on("event", async (p) => {
        ...
        this.debug("Subscription ready"), this.active = true, c();
      }), h.on("close", () => {
        this.debug("Subscription closed"), this.active = false;
      });
    })];
...
var NDKPool = class extends lib$1.EventEmitter {
  ...
  removeRelay(e) {
    ...
    if (n)
      return n.disconnect(), this.relays.delete(e), this.emit("relay:disconnect", n), true;
    const r = this.temporaryRelayTimers.get(e);
    return r && (clearTimeout(r), this.temporaryRelayTimers.delete(e)), false;
  }
  /**
...
async function fetchEventFromTag(t, e, n = {
  ...
  let c, h = a && a !== "" ? this.pool.getRelay(a, true, true, [{ ids: [o] }]) : void 0;
...
var Nip96 = class {
  ...
  async xhrUpload(t, e) {
    ...
    t.open(n, r, true), s.Authorization && t.setRequestHeader("Authorization", s.Authorization);
...
var NDK = class extends lib$1.EventEmitter {
  constructor(e = {}) {
    ...
    M(this, "queuesNip05");
    M(this, "asyncSigVerification", false);
    M(this, "validationRatio", 1);
    M(this, "relayAuthDefaultPolicy");
    M(this, "httpFetch");
    M(this, "autoConnectUserRelays", true);
    M(this, "autoFetchUserMutelist", true);
    ...
    }), this.autoConnectUserRelays = e.autoConnectUserRelays ?? true, this.autoFetchUserMutelist = e.autoFetchUserMutelist ?? true, this.clientName = e.clientName, this.clientNip89 = e.clientNip89, this.relayAuthDefaultPolicy = e.relayAuthDefaultPolicy, e.enableOutboxModel && (this.outboxPool = new NDKPool(
   ...
   * @returns
   */
  async getUserFromNip05(e, n = false) {
  ...
  async nwc(e, n = 2e3) {
    ...
    return n !== false && await r.blockUntilReady(n), r;
  }
};
...
(function(t, e) {
  (function(n, r) {
    ...
    function S(l, d, b, m) {
      k(l, d, h(b && y(b, "get") && typeof b.get == "function" ? { get: b.get, set: b.set, configurable: true } : { value: b, configurable: true, writable: true }, m));
    }
    function w(l) {
...
`);
 ...
 ` + _ : ""), this.inner = _ || null) : typeof v == "object" && (this.message = "".concat(v.name, " ").concat(v.message), this.inner = v) : (this.message = le[d] || b, this.inner = null);
    ...
    function jr(l, d) {
      return l === _e ? d : function() {
        return d.apply(this, arguments) !== false && l.apply(this, arguments);
      };
    }
    function wn(l, d) {
      return l === _e ? d : function() {
    ...
    var Rt = {}, ir = 100, ot = typeof Promise > "u" ? [] : function() {
      ...
      Ht.push([l, d]), zt && (queueMicrotask(Vr), zt = false);
    }, vn = true, zt = true, gt = [], Vt = [], En = Be, ct = { id: "global", global: true, ref: 0, unhandleds: [], onunhandled: _e, pgp: false, env: {}, finalize: _e }, Ee = ct, Ht = [], bt = 0, Wt = [];
    function $e(l) {
      ...
      if (typeof l != "function") {
        ...
        return this._state = arguments[1], this._value = arguments[2], void (this._state === false && _n(this, this._value));
      }
        ...
        try {
          v(function(_) {
            if (m._state === null) {
              ...
              }) : (m._state = true, m._value = _, or(m)), R && Bt();
            }
          }, _n.bind(null, m));
        } catch (_) {
          _n(m, _);
    ...
    function _n(l, d) {
      var b, m;
      Vt.push(d), l._state === null && (b = l._lib && _t(), d = En(d), l._state = false, l._value = d, m = l, gt.some(function(v) {
    ...
    function Ke(l, d) {
      ...
      return function() {
        var m = _t(), v = Ee;
        try {
          return ht(b, true), l.apply(this, arguments);
        } catch (_) {
          d && d(_);
        } finally {
          ht(v, false), m && Bt();
    ...
    function lt(l, d, b, m) {
      ...
      return _.parent = v, _.ref = 0, _.global = false, _.id = ++Gr, ct.env, _.env = $n ? { Promise: $e, PromiseProp: { value: $e, configurable: true, writable: true }, all: $e.all, race: $e.race, allSettled: $e.allSettled, any: $e.any, resolve: $e.resolve, reject: $e.reject } : {}, d && h(_, d), ++v.ref, _.finalize = function() {
    ...
    function ft() {
      return !!je.awaits && (--je.awaits == 0 && (je.id = 0), je.echoes = je.awaits * ir, true);
    }
    function Jt(l) {
    ...
    function ht(l, d) {
      ...
      (d ? !je.echoes || Yt++ && l === Ee : !Yt || --Yt && l === Ee) || queueMicrotask(d ? (function(v) {
        ++Xt, je.echoes && --je.echoes != 0 || (je.echoes = je.awaits = je.id = 0), Zt.push(Ee), ht(v, true);
    ...
    function cr(l, d, b, m) {
      return typeof l != "function" ? l : function() {
        ...
        try {
          ...
          ht(v, false), m && queueMicrotask(ft);
        }
      };
    }
    function kn(l) {
    ...
    var lr = { type: 3, lower: -1 / 0, lowerOpen: false, upper: [[]], upperOpen: false };
    function en(l) {
    ...
    function hr(l) {
      var d = typeof l;
      return d != "object" ? d : ArrayBuffer.isView(l) ? "binary" : (l = E2(l), l === "ArrayBuffer" ? "binary" : l);
    }
    function dr(l) {
    ...
    var pr = (De.prototype._trans = function(l, d, b) {
        ...
        var V = m && m.db._novip === this.db._novip ? m === Ee.trans ? m._promise(l, R, b) : lt(function() {
          ...
          if (Y.idbdb && (Y._state.openComplete || Ee.letThrough || Y._vip)) {
            ...
            try {
              ...
              return J2.name === Ae.InvalidState && Y.isOpen() && 0 < --Y._state.PR1398_maxLoop ? (console.warn("Dexie: Need to reopen db"), Y.close({ disableAutoOpen: false }), Y.open().then(function() {
                return j(Y, D, X, z);
              })) : Fe(J2);
            }
            return Z._promise(D, function(J2, G) {
              return lt(function() {
                return Ee.trans = Z, z(J2, G, Z);
              });
            }).then(function(J2) {
              if (D === "readwrite")
                try {
              ...
              return D === "readonly" ? J2 : Z._completion.then(function() {
                return J2;
              });
            });
          }
      ...
      var U = d.reduce(function(X, j) {
        ...
        return [Y || X, Y || !X ? $t(D, X && X.multi ? function(Z) {
          return Z = I(Z, j), c(Z) && Z.some(function(J2) {
            return _(z, J2);
          });
        } : function(Z) {
          return _(z, I(Z, j));
      ...
      return this._trans("readwrite", function(R) {
        return b.getMany({ trans: R, keys: m, cache: "clone" }).then(function(U) {
          ...
          l.forEach(function(D, X) {
            var z = D.key, Z = D.changes, J2 = U[X];
            if (J2) {
          ...
          return b.mutate({ trans: R, type: "put", keys: V, values: j, updates: { keys: m, changeSpecs: v } }).then(function(D) {
            ...
            if (X === 0)
              return Y;
            for (var Z = 0, J2 = Object.keys(z); Z < J2.length; Z++) {
              var G, ne = J2[Z], re = _[Number(ne)];
        ...
        a(j = R).forEach(function(D) {
          ...
          if (c(X))
            ...
            var z = _(D, Be, function() {
              for (var Z = arguments.length, J2 = new Array(Z); Z--; )
                J2[Z] = arguments[Z];
      ...
      if (l.or) {
        var _ = {}, R = function(U, V, j) {
          ...
          v && !v(V, j, function(X) {
            ...
            return V.fail(X);
          }) || ((D = "" + (Y = V.primaryKey)) == "[object ArrayBuffer]" && (D = "" + new Uint8Array(Y)), y(_, D) || (_[D] = true, d(U, V, j)));
        };
    ...
    var Yr = (Le.prototype._read = function(l, d) {
      ...
      return this._read(function(b) {
        var m = d._ctx;
        if (m.dir === "next" && St(m, true) && 0 < m.limit) {
          var v = m.valueMapper, _ = tn(m, m.table.core.schema);
          return m.table.core.query({ trans: b, limit: m.limit, values: true, query: { index: _, range: m.range } }).then(function(U) {
      ...
      var d = this._ctx;
      if (d.dir === "next" && St(d, true) && 0 < d.limit)
        return this._read(function(m) {
          var v = tn(d, d.table.core.schema);
          return d.table.core.query({ trans: m, values: false, limit: d.limit, query: { index: v, range: d.range } });
        }).then(function(m) {
          return m.result;
        }).then(l);
      d.keysOnly = !d.isMatch;
      ...
      return this._write(function(m) {
        ...
        R = typeof l == "function" ? l : (v = a(l), _ = v.length, function(G) {
          for (var ne = false, re = 0; re < _; ++re) {
            var se = v[re], ue = l[se], he = I(G, se);
            ue instanceof Cn ? (L(G, se, ue.execute(he)), ne = true) : he !== ue && (L(G, se, ue), ne = true);
          }
          return ne;
        });
        function U(G, se) {
        ...
        var V = b.table.core, j = V.schema.primaryKey, Y = j.outbound, D = j.extractKey, X = d.db._options.modifyChunkSize || 200, z = [], Z = 0, J2 = [];
        return d.clone().primaryKeys().then(function(G) {
          function ne(re) {
            ...
            return V.getMany({ trans: m, keys: G.slice(re, re + se), cache: "immutable" }).then(function(ue) {
              for (var he = [], be = [], pe = Y ? [] : null, ye = [], me = 0; me < se; ++me) {
                ...
                R.call(ke, ke.value, ke) !== false && (ke.value == null ? ye.push(G[re + me]) : Y || He(D(we), D(ke.value)) === 0 ? (be.push(ke.value), Y && pe.push(G[re + me])) : (ye.push(G[re + me]), he.push(ke.value)));
              }
          ...
          return ne(0).then(function() {
            if (0 < z.length)
              throw new Se("Error modifying one or more objects", z, Z, J2);
            return G.length;
          });
        });
      });
    ...
    function rn(l, d, b, m) {
      ...
      var z = 0;
      return l._addAlgorithm(function(Z, J2, G) {
        var ne = Z.key;
        if (typeof ne != "string")
          return false;
        var re = _(ne);
    ...
    var wr = (Object.defineProperty(ze.prototype, "Collection", { get: function() {
    ...
    }, enumerable: false, configurable: true }), ze.prototype.between = function(l, d, b, m) {
      b = b !== false, m = m === true;
      try {
      ...
      return l == null ? Je(this, st) : new this.Collection(this, function() {
        return dt(l, void 0, true);
      });
    }, ze.prototype.aboveOrEqual = function(l) {
      return l == null ? Je(this, st) : new this.Collection(this, function() {
        return dt(l, void 0, false);
      });
    }, ze.prototype.below = function(l) {
      return l == null ? Je(this, st) : new this.Collection(this, function() {
        return dt(void 0, l, false, true);
      });
      ...
      return typeof l != "string" ? Je(this, ur) : this.between(l, l + wt, true, true);
      ...
      return this.inAnyRange([[-1 / 0, l], [l, this.db._maxKey]], { includeLowers: false, includeUppers: false });
      ...
      return d.push([l[l.length - 1], this.db._maxKey]), this.inAnyRange(d, { includeLowers: false, includeUppers: false });
      ...
      var V = !d || d.includeLowers !== false, j = d && d.includeUppers === true, Y, D = v;
      function X(re, se) {
        return D(re[0], se[0]);
      }
      try {
      ...
      return ne._ondirectionchange = function(re) {
        D = re === "next" ? (G = Z, v) : (G = J2, _), Y.sort(X);
      }, ne._addAlgorithm(function(re, se, ue) {
        for (var he, be = re.key; G(be); )
          if (++z === Y.length)
            return se(ue), false;
        return !Z(he = be) && !J2(he) || (b._cmp(be, Y[z][1]) === 0 || b._cmp(be, Y[z][0]) === 0 || se(function() {
    ...
    function rt(l) {
      return Ke(function(d) {
        return Ot(d), l(d.target.error), false;
      });
    }
    function Ot(l) {
    ...
    var Dt = "storagemutated", Ln = "x-storagemutated-1", pt = Ut(null, Dt), Qr = (it.prototype._lock = function() {
      ...
      return W(this._completion._state === null), (l = this.idbtrans = l || (this.db.core || b).transaction(this.storeNames, this.mode, { durability: this.chromeTransactionDurability })).onerror = Ke(function(v) {
        ...
        Ot(v), d.active && d._reject(new de.Abort(l.error)), d.active = false, d.on("abort").fire(v);
      }), l.oncomplete = Ke(function() {
        d.active = false, d._resolve(), "mutatedParts" in l && pt.storagemutated.fire(l.mutatedParts);
      }), this;
      ...
      this.active && (this.active = false, this.idbtrans && this.idbtrans.abort(), this._reject(new de.Abort()));
    ...
    function ti(l, d, V) {
      function m(G) {
        ...
        var z = G.lower, Z = G.upper, J2 = G.lowerOpen, G = G.upperOpen;
        return z === void 0 ? Z === void 0 ? null : d.upperBound(Z, !!G) : Z === void 0 ? d.lowerBound(z, !!J2) : d.bound(z, Z, !!J2, !!G);
      }
      function v(X) {
        var z, Z = X.name;
        return { name: Z, schema: X, mutate: function(J2) {
          var G = J2.trans, ne = J2.type, re = J2.keys, se = J2.values, ue = J2.range;
        ...
        }, query: (z = j, function(J2) {
          return new Promise(function(G, ne) {
            G = Ke(G);
            var re, se, ue, ye = J2.trans, he = J2.values, be = J2.limit, we = J2.query, pe = be === 1 / 0 ? void 0 : be, me = we.index, we = we.range, ye = ye.objectStore(Z), me = me.isPrimaryKey ? ye : ye.index(me.name), we = m(we);
            if (be === 0)
              return G({ result: [] });
        ...
        }), openCursor: function(J2) {
          var G = J2.trans, ne = J2.values, re = J2.query, se = J2.reverse, ue = J2.unique;
          return new Promise(function(he, be) {
            he = Ke(he);
            ...
            we.onerror = rt(be), we.onsuccess = Ke(function(ke) {
              ...
              Ce ? (Ce.___id = ++ei, Ce.done = false, Ie = Ce.continue.bind(Ce), Ne = (Ne = Ce.continuePrimaryKey) && Ne.bind(Ce), Re = Ce.advance.bind(Ce), et = function() {
                ...
                function Ze() {
                  if (we.result)
                    ...
                    Ce.done = true, Ce.start = function() {
          ...
          var G = J2.query, ne = J2.trans, re = G.index, se = G.range;
      ...
      var _, R, U, Y = (R = V, U = vr((_ = l).objectStoreNames), { schema: { name: _.name, tables: U.map(function(X) {
        ...
        var z = X.keyPath, G = X.autoIncrement, Z = c(z), J2 = {}, G = { name: X.name, primaryKey: { name: null, isPrimaryKey: true, outbound: z == null, compound: Z, keyPath: z, autoIncrement: G, unique: true, extractKey: Pn(z) }, indexes: vr(X.indexNames).map(function(ne) {
          return X.index(ne);
        }).map(function(ue) {
        ...
        return J2[":id"] = G.primaryKey, z != null && (J2[Ft(z)] = G.primaryKey), G;
      ...
      b.forEach(function(v) {
        ...
        d.forEach(function(R) {
          ...
          (!U || "value" in U && U.value === void 0) && (R === l.Transaction.prototype || R instanceof l.Transaction ? S(R, v, { get: function() {
            ...
            k(this, v, { value: V, writable: true, configurable: true, enumerable: true });
          } }) : R[v] = new l.Table(v, _));
        });
      });
    }
    ...
    function ii(l, d, b, m) {
      ...
      lt(function() {
        return Ee.trans = _, Ee.transless = U, d !== 0 ? (sn(l, b), j = d, ((V = _).storeNames.includes("$meta") ? V.table("$meta").get("version").then(function(Y) {
          ...
          return X = Y, z = _, Z = b, J2 = [], Y = (D = l)._versions, G = D._dbSchema = cn(0, D.idbdb, Z), (Y = Y.filter(function(ne) {
            ...
            return J2.length ? $e.resolve(J2.shift()(z.idbtrans)).then(ne) : $e.resolve();
          }().then(function() {
            Er(G, Z);
          })) : $e.resolve();
          var D, X, z, Z, J2, G;
    ...
    function Dn(l, d) {
      ...
      for (b in d) {
        var v = l[b], _ = d[b];
        if (v) {
          var R = { name: b, def: _, recreate: false, del: [], add: [], change: [] };
          if ("" + (v.primKey.keyPath || "") != "" + (_.primKey.keyPath || "") || v.primKey.auto !== _.primKey.auto)
            R.recreate = true, m.change.push(R);
          else {
    ...
    function cn(l, d, b) {
      ...
      return N(d.objectStoreNames, 0).forEach(function(v) {
        for (var _ = b.objectStore(v), R = Hn($r(j = _.keyPath), j || "", true, false, !!_.autoIncrement, j && typeof j != "string", true), U = [], V = 0; V < _.indexNames.length; ++V) {
          var Y = _.index(_.indexNames[V]), j = Y.keyPath, Y = Hn(Y.name, j, !!Y.unique, !!Y.multiEntry, false, j && typeof j != "string", false);
          U.push(Y);
        }
        m[v] = Un(v, R, U);
      }), m;
    ...
    function un(l, d, b) {
      ...
      typeof navigator < "u" && /Safari/.test(navigator.userAgent) && !/(Chrome\/|Edge\/)/.test(navigator.userAgent) && o.WorkerGlobalScope && o instanceof o.WorkerGlobalScope && [].concat(navigator.userAgent.match(/Safari\/(\d*)/))[1] < 604 && (l._hasGetAll = false);
    }
    function xr(l) {
    ...
    var vt = {}, Wn = {}, Gn = false;
    function dn(l) {
      hn(Wn, l), Gn || (Gn = true, setTimeout(function() {
        Gn = false, Zn(Wn, !(Wn = {}));
      }, 0));
    }
    function Zn(l, d) {
    ...
    function ai(l) {
      ...
      d.isBeingOpened = true, d.dbOpenError = null, d.openComplete = false;
      var m = d.openCanceller, v = Math.round(10 * l.verno), _ = false;
      function R() {
      ...
      function U() {
        return new $e(function(X, z) {
          ...
          var Z = l.name, J2 = d.autoSchema || !v ? b.open(Z) : b.open(Z, v);
          if (!J2)
            throw new de.MissingAPI();
          J2.onerror = rt(z), J2.onblocked = Ke(l._fireOnBlocked), J2.onupgradeneeded = Ke(function(G) {
            var ne;
            Y = J2.transaction, d.autoSchema && !l._options.allowEmptyDB ? (J2.onerror = Ot, Y.abort(), J2.result.close(), (ne = b.deleteDatabase(Z)).onsuccess = ne.onerror = Ke(function() {
              z(new de.NoSuchDatabase("Database ".concat(Z, " doesnt exist")));
            })) : (Y.onerror = rt(z), G = G.oldVersion > Math.pow(2, 62) ? 0 : G.oldVersion, D = G < 1, l.idbdb = J2.result, _ && si(l, Y), ii(l, G / 10, Y, z));
          }, z), J2.onsuccess = Ke(function() {
            Y = null;
            var G, ne, re, se, ue, he = l.idbdb = J2.result, be = N(he.objectStoreNames);
            if (0 < be.length)
              try {
                ...
                if (d.autoSchema)
                  ...
                  return console.warn("Dexie SchemaDiff: Schema was extended without increasing the number passed to db.version(). Dexie will add missing parts and increment native version number to workaround this."), he.close(), v = he.version + 1, _ = true, X(U());
                sn(l, pe);
              } catch {
              }
            kt.push(l), he.onversionchange = Ke(function(ye) {
              d.vcFired = true, l.on("versionchange").fire(ye);
      ...
      var V, j = d.dbReadyResolve, Y = null, D = false;
      return $e.race([m, (typeof navigator > "u" ? $e.resolve() : !navigator.userAgentData && /Safari\//.test(navigator.userAgent) && !/Chrom(e|ium)\//.test(navigator.userAgent) && indexedDB.databases ? new Promise(function(X) {
        ...
        d.openCanceller === m && (d.onReadyBeingFired = null, d.isBeingOpened = false);
      }).catch(function(X) {
        d.dbOpenError = X;
        try {
          Y && Y.abort();
    ...
    var ci = { stack: "dbcore", name: "VirtualIndexMiddleware", level: 1, create: function(l) {
      return r(r({}, l), { table: function(d) {
        ...
        function R(D, X, z) {
          var Z = Ft(D), J2 = v[Z] = v[Z] || [], G = D == null ? 0 : typeof D == "string" ? 1 : D.length, ne = 0 < X, ne = r(r({}, z), { name: ne ? "".concat(Z, "(virtual-from:").concat(z.name, ")") : z.name, lowLevelIndex: z, isVirtual: ne, keyTail: X, keyLength: G, extractKey: Pn(D), unique: !ne && z.unique });
          return J2.push(ne), ne.isPrimaryKey || _.push(ne), 1 < G && R(G === 2 ? D[0] : D.slice(0, G - 1), X + 1, z), J2.sort(function(re, se) {
        ...
        function Y(D) {
          ...
          return z.isVirtual ? r(r({}, D), { query: { index: z.lowLevelIndex, range: (X = D.query.range, z = z.keyTail, { type: X.type === 1 ? 2 : X.type, lower: pn(X.lower, X.lowerOpen ? l.MAX_KEY : l.MIN_KEY, z), lowerOpen: true, upper: pn(X.upper, X.upperOpen ? l.MIN_KEY : l.MAX_KEY, z), upperOpen: true }) } }) : D;
        }
        return r(r({}, b), { schema: r(r({}, m), { primaryKey: d, indexes: _, getIndexByKeyPath: function(D) {
          ...
          var X = D.query.index, z = X.keyTail, Z = X.isVirtual, J2 = X.keyLength;
          return Z ? b.openCursor(Y(D)).then(function(ne) {
            return ne && G(ne);
          }) : b.openCursor(D);
          function G(ne) {
            return Object.create(ne, { continue: { value: function(re) {
              re != null ? ne.continue(pn(re, D.reverse ? l.MAX_KEY : l.MIN_KEY, z)) : D.unique ? ne.continue(ne.key.slice(0, J2).concat(D.reverse ? l.MIN_KEY : l.MAX_KEY, z)) : ne.continue();
              ...
              var re = ne.key;
              return J2 === 1 ? re[0] : re.slice(0, J2);
            } }, value: { get: function() {
              return ne.value;
            } } });
          }
    ...
    function Xn(l, d, b, m) {
      return b = b || {}, m = m || "", a(l).forEach(function(v) {
        var _, R, U;
        y(d, v) ? (_ = l[v], R = d[v], typeof _ == "object" && typeof R == "object" && _ && R ? (U = E2(_)) !== E2(R) ? b[m + v] = d[v] : U === "Object" ? Xn(_, R, b, m + v + ".") : _ !== R && (b[m + v] = d[v]) : _ !== R && (b[m + v] = d[v])) : b[m + v] = void 0;
    ...
    var ui = { stack: "dbcore", name: "HooksMiddleware", level: 2, create: function(l) {
      return r(r({}, l), { table: function(d) {
        ...
        return r(r({}, b), { mutate: function(v) {
            ...
            case "deleteRange":
              ...
              return _._promise("readwrite", function() {
                return function D(X, z, Z) {
                  return b.query({ trans: X, values: false, query: { index: m, range: z }, limit: Z }).then(function(J2) {
                    var G = J2.result;
                    return Y({ type: "delete", keys: G, trans: X }).then(function(ne) {
                      return 0 < ne.numFailures ? Promise.reject(ne.failures[0]) : G.length < Z ? { failures: [], numFailures: 0, lastResult: void 0 } : D(X, r(r({}, z), { lower: G[G.length - 1], lowerOpen: true }), Z);
                    });
                  });
                }(v.trans, v.range, 1e4);
              }, true);
          ...
          return b.mutate(v);
          function Y(D) {
            var X, z, Z, J2 = Ee.trans, G = D.keys || Jn(m, D);
            if (!G)
            ...
            return (D = D.type === "add" || D.type === "put" ? r(r({}, D), { keys: G }) : r({}, D)).type !== "delete" && (D.values = s([], D.values)), D.keys && (D.keys = s([], D.keys)), X = b, Z = G, ((z = D).type === "add" ? Promise.resolve([]) : X.getMany({ trans: z.trans, keys: Z, cache: "immutable" })).then(function(ne) {
              var re = G.map(function(se, ue) {
                ...
                return D.type === "delete" ? U.fire.call(me, se, ye, J2) : D.type === "add" || ye === void 0 ? (he = V.fire.call(me, se, D.values[ue], J2), se == null && he != null && (D.keys[ue] = se = he, m.outbound || L(D.values[ue], m.keyPath, se))) : (he = Xn(ye, D.values[ue]), (be = j.fire.call(me, he, se, ye, J2)) && (pe = D.values[ue], Object.keys(be).forEach(function(we) {
    ...
    var fi = { stack: "dbcore", level: 0, name: "Observability", create: function(l) {
      ...
      return r(r({}, l), { transaction: function(m, v, _) {
        ...
        var v = l.table(m), _ = v.schema, R = _.primaryKey, D = _.indexes, U = R.extractKey, V = R.outbound, j = R.autoIncrement && D.filter(function(z) {
          ...
          var J2, G, ne, re = z.trans, se = z.mutatedParts || (z.mutatedParts = {}), ue = Z(""), he = Z(":dels"), be = z.type, me = z.type === "deleteRange" ? [z.range] : z.type === "delete" ? [z.keys] : z.values.length < 50 ? [Jn(R, z).filter(function(we) {
            return we;
          }), z.values] : [], pe = me[0], ye = me[1], me = z.trans._cache;
          return c(pe) ? (ue.addKeys(pe), (me = be === "delete" || pe.length === ye.length ? kr(pe, me) : null) || he.addKeys(pe), (me || ye) && (J2 = Z, G = me, ne = ye, _.indexes.forEach(function(we) {
            var ke = J2(we.name || "");
            function Ie(Re) {
          ...
          var J2 = Z.query, Z = J2.index, J2 = J2.range;
          return [Z, new We((Z = J2.lower) !== null && Z !== void 0 ? Z : l.MIN_KEY, (J2 = J2.upper) !== null && J2 !== void 0 ? J2 : l.MAX_KEY)];
        }, X = { get: function(z) {
        ...
        return a(X).forEach(function(z) {
          Y[z] = function(Z) {
            var J2 = Ee.subscr, G = !!J2, ne = Sr(Ee, v) && Tr(z, Z) ? Z.obsSet = {} : J2;
            if (G) {
              var re = function(ye) {
                return ye = "idb://".concat(d, "/").concat(m, "/").concat(ye), ne[ye] || (ne[ye] = new We());
              }, se = re(""), ue = re(":dels"), J2 = X[z](Z), G = J2[0], J2 = J2[1];
              if ((z === "query" && G.isPrimaryKey && !Z.values ? ue : re(G.name || "")).add(J2), !G.isPrimaryKey) {
                if (z !== "count") {
                  var he = z === "query" && V && Z.values && v.query(r(r({}, Z), { values: false }));
    ...
    function Rr(l, d, X, m, v, _) {
      ...
      var R = d.query.index, U = R.multiEntry, V = d.query.range, j = m.schema.primaryKey.extractKey, Y = R.extractKey, D = (R.lowLevelIndex || R).extractKey, X = X.reduce(function(z, Z) {
        var J2 = z, G = Z.type === "add" || Z.type === "put" ? Z.values.filter(function(ue) {
        ...
        switch (Z.type) {
          case "add":
            J2 = z.concat(d.values ? G : G.map(function(he) {
              return j(he);
            }));
            break;
          case "put":
      ...
      }), d.limit && d.limit < 1 / 0 && (X.length > d.limit ? X.length = d.limit : l.length === d.limit && X.length < d.limit && (v.dirty = true)), _ ? Object.freeze(X) : X);
    }
    function Cr(l, d) {
    ...
    var pi = { stack: "dbcore", level: 0, name: "Cache", create: function(l) {
      ...
      return r(r({}, l), { transaction: function(b, m, v) {
          ...
          return function() {
            if (_.abort(), m === "readwrite") {
              for (var j = /* @__PURE__ */ new Set(), Y = 0, D = b; Y < D.length; Y++) {
                ...
                if (z) {
                  var Z = l.table(X), J2 = z.optimisticOps.filter(function(ke) {
                    return ke.trans === U;
                  });
                  if (U._explicit && V && U.mutatedParts)
                    ...
                    for (var ue = 0, he = Object.values(z.queries.query); ue < he.length; ue++)
                      for (var be, pe, ye, me = 0, we = (be = he[ue]).slice(); me < we.length; me++)
                        (pe = we[me]).res != null && U.mutatedParts && (V && !pe.dirty ? (ye = Object.isFrozen(pe.res), ye = Rr(pe.res, pe.req, J2, Z, pe, ye), pe.dirty ? (Q(be, pe), pe.subscribers.forEach(function(ke) {
                          return j.add(ke);
        ...
        }, U.addEventListener("abort", v(false), { signal: R }), U.addEventListener("error", v(false), { signal: R }), U.addEventListener("complete", v(true), { signal: R })), U;
      }, table: function(b) {
        ...
        return r(r({}, m), { mutate: function(_) {
          ...
          if (!Sr(Ee, m) || !Tr("query", _))
            return m.query(_);
          var R = ((j = Ee.trans) === null || j === void 0 ? void 0 : j.db._options.cache) === "immutable", D = Ee, U = D.requery, V = D.signal, j = function(Z, J2, G, ne) {
            var re = vt["idb://".concat(Z, "/").concat(J2)];
            if (!re)
              return [];
            if (!(J2 = re.queries[G]))
              return [null, false, re, null];
            var se = J2[(ne.query ? ne.query.index.name : null) || ""];
            if (!se)
              return [null, false, re, null];
            switch (G) {
              case "query":
                ...
                return ue ? [ue, true, re, se] : [se.find(function(he) {
          ...
          return Y && D ? Y.obsSet = _.obsSet : (D = m.query(_).then(function(Z) {
            var J2 = Z.result;
            if (Y && (Y.res = J2), R) {
              for (var G = 0, ne = J2.length; G < ne; ++G)
                Object.freeze(J2[G]);
              Object.freeze(J2);
            } else
              Z.result = K(J2);
          ...
          }), Y = { obsSet: _.obsSet, promise: D, subscribers: /* @__PURE__ */ new Set(), type: "query", req: _, dirty: false }, z ? z.push(Y) : (z = [Y], (X = X || (vt["idb://".concat(d, "/").concat(b)] = { queries: { query: {}, count: {} }, objs: /* @__PURE__ */ new Map(), optimisticOps: [], unsignaledParts: {} })).queries.query[_.query.index.name || ""] = z)), di(Y, z, U, V), Y.promise.then(function(Z) {
    ...
    var at = (Me.prototype.version = function(l) {
      ...
      return b || (b = new this.Version(l), d.push(b), d.sort(ri), b.stores({}), this._state.autoSchema = false, b);
      ...
      var d = (b === void 0 ? { disableAutoOpen: true } : b).disableAutoOpen, b = this._state;
      d ? (b.isBeingOpened && b.cancelOpen(new de.DatabaseClosed()), this._close(), b.autoOpen = false, b.dbOpenError = new de.DatabaseClosed()) : (this._close(), b.autoOpen = this._options.autoOpen || b.isBeingOpened, b.openComplete = false, b.dbOpenError = null);
    }, Me.prototype.delete = function(l) {
      var d = this;
      l === void 0 && (l = { disableAutoOpen: true });
    ...
    }, enumerable: false, configurable: true }), Me.prototype.transaction = function() {
      ...
      var V = (function j(Y, D, X, z, Z) {
        return $e.resolve().then(function() {
          var J2 = Ee.transless || Ee, G = Y._createTransaction(D, X, Y._dbSchema, z);
          if (G.explicit = true, J2 = { trans: G, transless: J2 }, z)
            G.idbtrans = z.idbtrans;
          else
            try {
              G.create(), G.idbtrans._explicit = true, Y._state.PR1398_maxLoop = 3;
            } catch (se) {
              return se.name === Ae.InvalidState && Y.isOpen() && 0 < --Y._state.PR1398_maxLoop ? (console.warn("Dexie: Need to reopen db"), Y.close({ disableAutoOpen: false }), Y.open().then(function() {
                return j(Y, D, X, null, Z);
              })) : Fe(se);
            }
          var ne, re = oe(Z);
          return re && At(), J2 = $e.follow(function() {
            var se;
            (ne = Z.call(G, G)) && (re ? (se = ft.bind(null, null), ne.then(se, se)) : typeof ne.next == "function" && typeof ne.throw == "function" && (ne = Yn(ne)));
          }, J2), (ne && typeof ne.then == "function" ? $e.resolve(ne).then(function(se) {
    ...
    function Me(l, d) {
      ...
      this._options = d = r({ addons: Me.addons, autoOpen: true, indexedDB: m.indexedDB, IDBKeyRange: m.IDBKeyRange, cache: "cloned" }, d), this._deps = { indexedDB: d.indexedDB, IDBKeyRange: d.IDBKeyRange }, m = d.addons, this._dbSchema = {}, this._versions = [], this._storeNames = [], this._allTables = {}, this.idbdb = null, this._novip = this;
      var v, _, R, U, V, j = { dbOpenError: null, isBeingOpened: false, onReadyBeingFired: null, openComplete: false, dbReadyResolve: _e, dbReadyPromise: null, cancelOpen: _e, openCanceller: null, autoSchema: true, PR1398_maxLoop: 3, autoOpen: d.autoOpen };
      j.dbReadyPromise = new $e(function(D) {
        j.dbReadyResolve = D;
      }), j.openCanceller = new $e(function(D, X) {
        j.cancelOpen = X;
      }), this._state = j, this.name = l, this.on = Ut(this, "populate", "blocked", "versionchange", "close", { ready: [wn, _e] }), this.on.ready.subscribe = C2(this.on.ready.subscribe, function(D) {
        return function(X, z) {
          Me.vip(function() {
            var Z, J2 = b._state;
            J2.openComplete ? (J2.dbOpenError || $e.resolve().then(X), z && D(X)) : J2.onReadyBeingFired ? (J2.onReadyBeingFired.push(X), z && D(X)) : (D(X), Z = b, z || D(function G() {
        ...
        var J2 = ne._ctx, G = J2.table, ne = G.hook.reading.fire;
        this._ctx = { table: G, index: J2.index, isPrimKey: !J2.index || G.schema.primKey.keyPath && J2.index === G.schema.primKey.name, range: z, keysOnly: false, dir: "next", unique: "", algorithm: null, filter: null, replayFilter: null, justLimit: true, isMatch: null, offset: 0, limit: 1 / 0, error: Z, or: J2.or, valueMapper: ne !== Be ? ne : null };
      ...
      })), this.Transaction = (R = this, Pt(Qr.prototype, function(D, X, z, Z, J2) {
        var G = this;
        this.db = R, this.mode = D, this.storeNames = X, this.schema = z, this.chromeTransactionDurability = Z, this.idbtrans = null, this.on = Ut(this, "complete", "error", "abort"), this.parent = J2 || null, this.active = true, this._reculock = 0, this._blockedFuncs = [], this._resolve = null, this._reject = null, this._waitingFor = null, this._waitingQueue = null, this._spinCount = 0, this._completion = new $e(function(ne, re) {
          G._resolve = ne, G._reject = re;
        }), this._completion.then(function() {
          G.active = false, G.on.complete.fire();
        }, function(ne) {
          var re = G.active;
          return G.active = false, G.on.error.fire(ne), G.parent ? G.parent._reject(ne) : re && G.idbtrans && G.idbtrans.abort(), Fe(ne);
        });
        ...
        if (this.db = V, this._ctx = { table: D, index: X === ":id" ? null : X, or: z }, this._cmp = this._ascending = He, this._descending = function(Z, J2) {
          return He(J2, Z);
        }, this._max = function(Z, J2) {
          return 0 < He(Z, J2) ? Z : J2;
        }, this._min = function(Z, J2) {
          return He(Z, J2) < 0 ? Z : J2;
        }, this._IDBKeyRange = V._deps.IDBKeyRange, !this._IDBKeyRange)
          throw new de.MissingAPI();
      })), this.on("versionchange", function(D) {
        0 < D.newVersion ? console.warn("Another connection wants to upgrade database '".concat(b.name, "'. Closing db now to resume the upgrade.")) : console.warn("Another connection wants to delete database '".concat(b.name, "'. Closing db now to resume the delete request.")), b.close({ disableAutoOpen: false });
      ...
      var Y = new Proxy(this, { get: function(D, X, z) {
        ...
        if (X === "table")
          return function(J2) {
            return yn(b.table(J2), Y);
          };
        var Z = Reflect.get(D, X, z);
        return Z instanceof pr ? yn(Z, Y) : X === "tables" ? Z.map(function(J2) {
          return yn(J2, Y);
    ...
    function Nr(l) {
      var d, b = false, m = new yi(function(v) {
        var _ = oe(l), R, U = false, V = {}, j = {}, Y = { get closed() {
          return U;
        }, unsubscribe: function() {
          U || (U = true, R && R.abort(), D && pt.storagemutated.unsubscribe(z));
        } };
        v.start && v.start(Y);
        var D = false, X = function() {
          return kn(Z);
        }, z = function(J2) {
          hn(V, J2), Vn(j, V) && X();
        }, Z = function() {
          var J2, G, ne;
          !U && gn.indexedDB && (V = {}, J2 = {}, R && R.abort(), R = new AbortController(), ne = function(re) {
            var se = _t();
            try {
              _ && At();
              var ue = lt(l, re);
          ...
          }(G = { subscr: J2, signal: R.signal, requery: X, querier: l, trans: null }), Promise.resolve(ne).then(function(re) {
            b = true, d = re, U || G.signal.aborted || (V = {}, function(se) {
              for (var ue in se)
                if (y(se, ue))
                  return;
              return 1;
            }(j = J2) || D || (pt(Dt, z), D = true), kn(function() {
              return !U && v.next && v.next(re);
            }));
          }, function(re) {
            b = false, ["DatabaseClosedError", "AbortError"].includes(re == null ? void 0 : re.name) || U || kn(function() {
    ...
    function tr(l) {
      var d = yt;
      try {
        yt = true, pt.storagemutated.fire(l), Zn(l, true);
      } finally {
        yt = d;
      }
    }
    $(Et, r(r({}, Ve), { delete: function(l) {
      ...
      rr(l);
    } }, derive: w, extend: h, props: $, override: C2, Events: Ut, on: pt, liveQuery: Nr, extendObservabilitySet: hn, getByKeyPath: I, setByKeyPath: L, delByKeyPath: function(l, d) {
      ...
      yt || (l = new CustomEvent(Ln, { detail: l }), yt = true, dispatchEvent(l), yt = false);
    }), addEventListener(Ln, function(l) {
      l = l.detail, yt || tr(l);
    }));
    var It, yt = false, Lr = function() {
    };
    return typeof BroadcastChannel < "u" && ((Lr = function() {
      ...
      if (!at.disableBfCache && l.persisted) {
        ...
        for (var d = 0, b = kt; d < b.length; d++)
          b[d].close({ disableAutoOpen: false });
      }
...
async function profilesWarmUp(t, e) {
  await e.each((n) => {
    t.set(n.pubkey, n.profile, false);
  });
}
...
async function eventTagsWarmUp(t, e) {
  await e.each((n) => {
    t.add(n.tagValue, n.eventId, false);
  });
}
...
var NDKCacheAdapterDexie = class {
  constructor(t = {}) {
    ...
    M(this, "events");
    M(this, "eventTags");
    M(this, "warmedUp", false);
    M(this, "warmUpPromise");
    M(this, "devMode", false);
    M(this, "_onReady");
    ...
    this.warmUpPromise = Promise.allSettled([
      ...
      const n = Date.now();
      this.warmedUp = true, this.ready = true, this.debug("Warm up completed, time", n - e, "ms"), this._onReady && this._onReady();
    });
  }
  onReady(t) {
    this._onReady = t;
  ...
  async setEvent(t, e, n) {
    ...
    if (t.isParamReplaceable()) {
      ...
      s && t.created_at && s.createdAt > t.created_at && (r = false);
    }
...
function foundEvent(t, e, n, r) {
  try {
    ...
    o.relay = a, t.eventReceived(o, a, true);
  } catch (s) {
...
function newUserLogin(t) {
  ...
  J.get("user/privateKey").put(r), J.get("user/publicKey").put(n), privateKeySigner = new NDKPrivateKeySigner(r), ndkInstance.signer = privateKeySigner;
...
function privateKeyLogin(t) {
  if (ndk(), t && typeof t == "string") {
    ...
    J.get("user/privateKey").put(n), J.get("user/publicKey").put(r);
  }
}
var EVENT_KIND = 30078;
var log = debug("nostree:ndk-adapter");
var NDKAdapter = class {
  constructor(e, n) {
...
var publicState = (t) => {
  let e;
  return typeof t == "string" ? e = [new PublicKey(t)] : e = t.map((n) => n instanceof PublicKey ? n : new PublicKey(n)), new E({
    adapters: [new C.MemoryAdapter(), new NDKAdapter(ndk(), e)]
  });
};
var tt = class tt2 {
  static id(e) {
    ...
    const n = tt2.strToUniqueId.get(e);
    if (n)
      return n;
    const r = tt2.currentUniqueId++;
    return tt2.strToUniqueId.set(e, r), tt2.uniqueIdToStr.set(r, e), r;
  }
  static str(e) {
    const n = tt2.uniqueIdToStr.get(e);
    if (!n)
      throw new Error("pub: invalid id " + e);
    return n;
  }
  static has(e) {
    return tt2.strToUniqueId.has(e);
  }
};
M(tt, "strToUniqueId", /* @__PURE__ */ new Map()), M(tt, "uniqueIdToStr", /* @__PURE__ */ new Map()), M(tt, "currentUniqueId", 0);
var UniqueIds = tt;
var STR = UniqueIds.str;
var ID = UniqueIds.id;
var SocialGraph = class {
  /**
...
irisdb-nostr/dist/irisdb-nostr.es.js:
  (*! noble-hashes - MIT License (c) 2022 Paul Miller (paulmillr.com) *)
  (*! noble-curves - MIT License (c) 2022 Paul Miller (paulmillr.com) *)
  (*! scure-base - MIT License (c) 2022 Paul Miller (paulmillr.com) *)
  (*! noble-ciphers - MIT License (c) 2023 Paul Miller (paulmillr.com) *)
*/
//# sourceMappingURL=chunk-RUGU4AMR.js.map
